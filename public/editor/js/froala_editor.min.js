...
!(function (e, t) {
      ...
      function e(e, t) {
        ...
        e[t] = function (e) {
          var t,
            n = !1,
            r = !1;
          if (!e || Array.isArray(e) || (!e.match(a) && !e.match(s)))
          ...
          return (
            ...
            (t = i.call(
              o,
              e.replace(a, "#".concat(this.id)).replace(s, ",#".concat(this.id))
            )),
            n && (this.id = ""),
          ...
          if ("Element" in e) {
            ...
            if (
              ...
              try {
                ...
                (void 0 !== u.number && -2146823252 !== u.number) ||
                  ((p.enumerable = !1), o.defineProperty(r, t, p));
              }
  ...
  (V.RegisterPlugins = function (e) {
    ...
    (V.MODULES.node = function (a) {
      ...
      function l(e) {
        return (
          ...
          0 <= V.BLOCK_TAGS.indexOf(e.tagName.toLowerCase())
        );
      }
      function c(e) {
        var t = {},
      ...
      function t(e) {
        for (
          var t = "", n = c(e), r = Object.keys(n).sort(), o = 0;
          o < r.length;
          o++
        ) {
          var i = r[o],
      ...
      return {
        ...
        isEmpty: function d(e, t) {
          ...
          for (var r = !1, o = 0; o < n.length; o++) {
            ...
            if (
              !(
                (t && a.node.hasClass(i, "fr-marker")) ||
                (i.nodeType === Node.TEXT_NODE && 0 === i.textContent.length)
              )
            ) {
              if (
                "BR" !== i.tagName &&
          ...
          return !(
            e.querySelectorAll(V.VOID_ELEMENTS.join(",")).length -
              e.querySelectorAll("br").length ||
            e.querySelector(
              "".concat(
                a.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),"),
                ":not(.fr-marker)"
              )
            ) ||
            1 < e.querySelectorAll(V.BLOCK_TAGS.join(",")).length ||
            e.querySelector(
              "".concat(
                a.opts.htmlDoNotWrapTags.join(":not(.fr-marker),"),
                ":not(.fr-marker)"
              )
            )
          );
        ...
        blockParent: function o(e) {
          for (
            ...
            e &&
            e.parentNode !== a.el &&
            (!e.parentNode || !a.node.hasClass(e.parentNode, "fr-inner"));
        ...
        deepestParent: function i(e, t, n) {
          if (
            ...
            0 <= t.indexOf(e.parentNode) ||
              (e.parentNode && a.node.hasClass(e.parentNode, "fr-inner")) ||
              (e.parentNode &&
                0 <= V.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) &&
                n))
          )
            return null;
          for (
            ...
            (V.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) < 0 || !n) &&
            (!l(e) || l(e.parentNode)) &&
        ...
        isFirstSibling: function h(e, t) {
          ...
          for (
            ...
            n && t && a.node.hasClass(n, "fr-marker");

          )
            n = n.previousSibling;
          return (
            !n ||
            (n.nodeType === Node.TEXT_NODE && "" === n.textContent && h(n))
          );
        },
        isLastSibling: function g(e, t) {
          ...
          return (
            !n ||
            (n.nodeType === Node.TEXT_NODE && "" === n.textContent && g(n))
          );
        },
        isList: function m(e) {
        ...
        isVoid: function v(e) {
          return (
            e &&
            e.nodeType === Node.ELEMENT_NODE &&
            0 <= V.VOID_ELEMENTS.indexOf((e.tagName || "").toLowerCase())
          );
        },
        hasFocus: function b(e) {
          return (
            e === a.doc.activeElement &&
            (!a.doc.hasFocus || a.doc.hasFocus()) &&
        ...
        isDeletable: function E(e) {
          return (
            ...
            0 <= (e.getAttribute("class") || "").indexOf("fr-deletable")
          );
        },
    ...
    (V.HTML5Map = { B: "STRONG", I: "EM", STRIKE: "S" }),
    (V.MODULES.clean = function (f) {
        ...
        for (t = 0; t < n.length; t++)
          n[t].nodeType !== Node.ELEMENT_NODE || f.node.isVoid(n[t])
            ? n[t].nodeType === Node.TEXT_NODE &&
              (n[t].textContent = n[t].textContent.replace(/\u200b/g, ""))
            : n[t].textContent.replace(/\u200b/g, "").length !==
                n[t].textContent.length && o(n[t]);
        if (
          e.nodeType === Node.ELEMENT_NODE &&
          !f.node.isVoid(e) &&
          (e.normalize(),
          ...
          for (t = 0; t < n.length; t++)
            if (
              ...
              (n[t].getAttribute("class") || "").indexOf("fr-marker") < 0
            )
              return !1;
      ...
      function m(e) {
        var t = e.replace(/;;/gi, ";");
        return (
          ";" !== (t = t.replace(/^;/gi, "")).charAt(t.length) && (t += ";"), t
        );
      }
      function c(e) {
        var t;
        ...
        return (
          ...
          (function a(e) {
            return (e = (e = (e = e.replace(
              ...
              function (e, t) {
                return 0 <= f.opts.htmlRemoveTags.indexOf("script")
                  ? ""
                  : l[parseInt(t, 10)];
              }
            )).replace(
            ...
            (function s(e, t, n) {
              if (f.opts.fullPage) {
                ...
                t =
                  null === t
                    ? f.html.extractNode(n, "head") || "<title></title>"
                    : t;
        ...
        !(function c(a) {
          ...
          if (
            ...
            a.nodeType === Node.ELEMENT_NODE &&
              (a.getAttribute("data-fr-src") &&
                0 !== a.getAttribute("data-fr-src").indexOf("blob:") &&
                a.setAttribute(
                  "data-fr-src",
                  f.helpers.sanitizeURL(b(a.getAttribute("data-fr-src")))
                ),
              a.getAttribute("href") &&
                a.setAttribute(
                  "href",
                  f.helpers.sanitizeURL(b(a.getAttribute("href")))
                ),
              a.getAttribute("src") &&
                a.setAttribute(
                  "src",
                  f.helpers.sanitizeURL(b(a.getAttribute("src")))
                ),
              a.getAttribute("srcdoc") &&
                a.setAttribute(
                  "srcdoc",
                  f.clean.html(a.getAttribute("srcdoc"))
                ),
              0 <= ["TABLE", "TBODY", "TFOOT", "TR"].indexOf(a.tagName) &&
                (a.innerHTML = a.innerHTML.trim())),
            !f.opts.pasteAllowLocalImages &&
              a.nodeType === Node.ELEMENT_NODE &&
              "IMG" === a.tagName &&
              a.getAttribute("data-fr-src") &&
              0 === a.getAttribute("data-fr-src").indexOf("file://"))
          )
            return a.parentNode.removeChild(a), !1;
          if (
            a.nodeType === Node.ELEMENT_NODE &&
            V.HTML5Map[a.tagName] &&
            "" === f.node.attributes(a)
          ) {
              ...
              if (n)
                for (var r = n.length - 1; 0 <= r; r--) {
                  ...
                  "style" === o.nodeName &&
                    ...
                    i && s
                      ? (o.value = m(s.join(";")))
                      : (i && ("style" !== o.nodeName || s)) ||
                        a.removeAttribute(o.nodeName);
                }
            }
          else
            0 !== a.data.indexOf("[FROALA.EDITOR") &&
              a.parentNode.removeChild(a);
        })(e);
      }
      return {
          ...
          !(function s() {
            for (
              ...
              if (!1 !== r && 0 !== n.length) {
                for (
                  var i = e[t];
                  i && "TABLE" !== i.tagName && "THEAD" !== i.tagName;

                )
                  i = i.parentNode;
                var a = i;
                "THEAD" !== a.tagName &&
                  ((a = f.doc.createElement("THEAD")),
        ...
        lists: function y() {
          !(function s() {
            ...
            do {
              ...
              t = [];
              for (
                var i = f.el.querySelectorAll("li"), a = 0;
                a < i.length;
                a++
              )
            ...
            (function i() {
              for (
                var e = f.el.querySelectorAll("ol + ol, ul + ul"), t = 0;
                t < e.length;
                t++
              ) {
                var n = e[t];
            ...
            (function a() {
              for (
                ...
                for (
                  var n = f.node.contents(e[t]), r = null, o = n.length - 1;
                  0 <= o;
                  o--
                )
                  "LI" !== n[o].tagName &&
                  ...
                  "OL" != n[o].tagName
                    ? (r ||
                        (r = g(f.doc.createElement("LI"))).insertBefore(n[o]),
                      r.prepend(n[o]))
                    : (r = null);
            })(),
            (function l() {
            ...
            (function c() {
              for (
                var e = f.el.querySelectorAll("li > ul, li > ol"), t = 0;
                t < e.length;
                t++
              ) {
                var n = e[t];
                if (n.nextSibling)
                  for (var r = n.nextSibling; 0 < r.childNodes.length; )
                    n.append(r.childNodes[0]);
              }
            })(),
            (function d() {
              for (
                ...
                var n = e[t];
                if (
                  f.node.isFirstSibling(n) &&
                  "none" != n.parentNode.style.listStyleType
                )
                  g(n).before("<br/>");
                else if (
                  n.previousSibling &&
                  ...
                  for (
                    var r = n.previousSibling.previousSibling;
            ...
            (function n() {
              for (
                var e = f.el.querySelectorAll("li:empty"), t = 0;
                t < e.length;
                t++
              )
                g(e[t]).remove();
    ...
    (V.MD = 2),
    (V.LG = 3);
  (V.LinkRegExCommon = "[".concat(
    "a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.",
    "]{1,}"
  )),
    (V.LinkRegExEnd =
      "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())"),
    (V.LinkRegExTLD = "((".concat(
      V.LinkRegExCommon,
      ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"
    )),
    (V.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(
      V.LinkRegExCommon,
      ")"
    )),
    (V.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(
      V.LinkRegExCommon,
      ")"
    )),
    (V.LinkRegExWWW = "(www\\.".concat(
      V.LinkRegExCommon,
      "\\.[a-z0-9-]{2,24})"
    )),
    (V.LinkRegEx = "("
      .concat(V.LinkRegExTLD, "|")
      .concat(V.LinkRegExHTTP, "|")
      .concat(V.LinkRegExWWW, "|")
      .concat(V.LinkRegExAuth, ")")
      .concat(V.LinkRegExEnd)),
    ...
    (V.MODULES.helpers = function (i) {
      ...
      return {
        ...
        isMac: function d() {
          return (
            null === l &&
              (l = 0 <= navigator.platform.toUpperCase().indexOf("MAC")),
            l
          );
        },
        isAndroid: n,
        ...
        isArray: function v(e) {
          return (
            e &&
            !Object.prototype.propertyIsEnumerable.call(e, "length") &&
            "object" === N(e) &&
        ...
        isURL: function E(e) {
          return (
            ...
            ((e = String(e)
              ...
              .replace(/ /g, "%20")),
            new RegExp(
              "^".concat(V.LinkRegExHTTP).concat(V.LinkRegExEnd, "$"),
              "gi"
            ).test(e))
          );
        },
        ...
        scrollTop: function S() {
          return i.o_win.pageYOffset
            ? i.o_win.pageYOffset
            : i.o_doc.documentElement && i.o_doc.documentElement.scrollTop
            ? i.o_doc.documentElement.scrollTop
            : i.o_doc.body.scrollTop
            ? i.o_doc.body.scrollTop
            : 0;
        },
        scrollLeft: function T() {
          return i.o_win.pageXOffset
            ? i.o_win.pageXOffset
            : i.o_doc.documentElement && i.o_doc.documentElement.scrollLeft
            ? i.o_doc.documentElement.scrollLeft
            : i.o_doc.body.scrollLeft
            ? i.o_doc.body.scrollLeft
            : 0;
        },
        isInViewPort: function M(e) {
          ...
          return (
            (0 <=
              (t = { top: Math.round(t.top), bottom: Math.round(t.bottom) })
                .top &&
              t.bottom <=
                (window.innerHeight ||
    ...
    (V.MODULES.events = function (l) {
      ...
      function c(e) {
        ...
        if ((l.helpers.isIOS() && l.$win.get(0).focus(), l.core.hasFocus()))
          return !1;
        if (!l.core.hasFocus() && e) {
          ...
          if (
            ...
            0 == l.browser.msie &&
              (p(), l.el.focus(), l.events.trigger("focus"), f()),
      ...
      function h(e, t, n) {
        ...
        void 0 === n && (n = !1),
          (r =
            0 !== e.indexOf("shared.")
              ? ((a[e] = a[e] || []), a[e])
              : ((l.shared._events[e] = l.shared._events[e] || []),
                l.shared._events[e])),
      ...
      function m(e, t, n, r, o) {
        ...
        var i = o ? l.shared.$_events : g,
          a = o ? l.sid : l.id,
          s = ""
            .concat(t.trim().split(" ").join(".ed".concat(a, " ")), ".ed")
            .concat(a);
              ...
              s(
                ...
                h("mousedown", function () {
                  for (var e = 0; e < V.INSTANCES.length; e++)
                    V.INSTANCES[e] !== l &&
                      V.INSTANCES[e].popups &&
                      V.INSTANCES[e].popups.areVisible() &&
                      V.INSTANCES[e].$el.find(".fr-marker").remove();
                });
            })(),
            (function n() {
        ...
        bindClick: function r(e, t, n) {
          m(
                ...
                (function n(e) {
                  ...
                  return l.edit.isDisabled() ||
                    ...
                    : ("mousedown" === e.type && 1 !== e.which) ||
                        (l.helpers.isMobile() || e.preventDefault(),
                        (l.helpers.isAndroid() || l.helpers.isWindowsPhone()) &&
                          0 === t.parents(".fr-dropdown-menu").length &&
              ...
              function (e) {
                l.edit.isDisabled() ||
                  (function o(e, t) {
                    ...
                    if (
                      l.edit.isDisabled() ||
                      l.node.hasClass(n.get(0), "fr-disabled")
                    )
                      return e.preventDefault(), !1;
                    if ("mouseup" === e.type && 1 !== e.which) return !0;
                    if (
                      l.button.getButtons(".fr-selected", !0).get(0) ==
                        n.get(0) &&
            ...
            m(e, "mouseover", t, function () {
              i(this).hasClass("fr-options") &&
                i(this).prev(".fr-btn").addClass("fr-btn-hover"),
                i(this).next(".fr-btn").hasClass("fr-options") &&
                  i(this).next(".fr-btn").addClass("fr-btn-hover");
            }),
            m(e, "mouseout", t, function () {
              i(this).hasClass("fr-options") &&
                i(this).prev(".fr-btn").removeClass("fr-btn-hover"),
                i(this).next(".fr-btn").hasClass("fr-options") &&
                  i(this).next(".fr-btn").removeClass("fr-btn-hover");
            });
        },
        disableBlur: p,
        enableBlur: f,
        ...
        chainTrigger: function E(e, t, n) {
          if (!l.edit.isDisabled() || n) {
            ...
            return (
              l.opts.events &&
                l.opts.events[e] &&
                void 0 !== (o = l.opts.events[e].apply(l, [t])) &&
                (t = o),
              t
            );
          }
    ...
    Object.assign(V.DEFAULTS, { indentMargin: 20 }),
    (V.COMMANDS = {
      bold: {
        title: "Bold",
        toggle: !0,
    ...
    (V.MODULES.commands = function (a) {
      ...
      var i = {
        ...
        insertHR: function () {
          ...
          var t,
            n = a.$el.find("hr#fr-just").length
              ? a.$el.find("hr#fr-just")
              : a.$el.find(".fr-just");
          if (
            (n.removeAttr("id"), n.removeAttr("class"), 0 === n.next().length)
          ) {
            var r = a.html.defaultTag();
            r
              ? n.after(s(a.doc.createElement(r)).append("<br>").get(0))
              : n.after("<br>");
          }
          n.prev().is("hr")
            ? (t = a.selection.setAfter(n.get(0), !1))
            : n.next().is("hr")
            ? (t = a.selection.setBefore(n.get(0), !1))
            : a.selection.setAfter(n.get(0), !1) ||
              a.selection.setBefore(n.get(0), !1),
            t ||
              void 0 === t ||
              ((e = o((e = "".concat(V.MARKERS, "<br>")))), n.after(e)),
            a.selection.restore();
        },
      ...
      function t(e) {
        !(function n(e) {
          ...
          a.$tb.find(".fr-open").not(e).removeClass("fr-open"),
            ...
            a.$tb.find(".fr-expanded").not(t).length
              ? (a.$tb.find(".fr-expanded").toggleClass("fr-expanded"),
      ...
      function n(e, t) {
        if (!1 !== a.events.trigger("commands.before", s.merge([e], t || []))) {
          var n = (V.COMMANDS[e] && V.COMMANDS[e].callback) || i[e],
            ...
            o = !1;
          V.COMMANDS[e] &&
            ("undefined" != typeof V.COMMANDS[e].focus &&
              (r = V.COMMANDS[e].focus),
            "undefined" != typeof V.COMMANDS[e].accessibilityFocus &&
              (o = V.COMMANDS[e].accessibilityFocus)),
            ((!a.core.hasFocus() && r && !a.popups.areVisible()) ||
              (!a.core.hasFocus() && o && a.accessibility.hasFocus())) &&
              a.events.focus(!0),
            V.COMMANDS[e] &&
              !1 !== V.COMMANDS[e].undo &&
              (a.$el.find(".fr-marker").length &&
                (a.events.disableBlur(), a.selection.restore()),
              a.undo.saveStep()),
        ...
        for (var t = a.selection.blocks(), n = 0; n < t.length; n++)
          if ("LI" !== t[n].tagName || "LI" !== t[n].parentNode.tagName) {
            ...
            "LI" != t[n].tagName &&
              ...
              (r = s(t[n].parentNode));
            var o =
                "rtl" === a.opts.direction || "rtl" === r.css("direction")
                  ? "margin-right"
                  : "margin-left",
              i = a.helpers.getPX(r.css(o));
            if (r.width() < 2 * a.opts.indentMargin && 0 < e) continue;
            "UL" != t[n].parentNode.tagName &&
              "OL" != t[n].parentNode.tagName &&
              "LI" != t[n].parentNode.tagName &&
        ...
        _init: function f() {
          a.events.on("keydown", function (e) {
            ...
            a.events.on("keyup", function (e) {
              ...
              if (t && "HR" === t.tagName)
                if (
                  e.which === V.KEYCODE.ARROW_LEFT ||
                  e.which === V.KEYCODE.ARROW_UP
                ) {
                  if (t.previousSibling)
                    return (
                      a.node.isBlock(t.previousSibling)
                        ? a.selection.setAtEnd(t.previousSibling)
                        : s(t).before(V.MARKERS),
                      a.selection.restore(),
                      !1
                    );
                } else if (
                  (e.which === V.KEYCODE.ARROW_RIGHT ||
                    e.which === V.KEYCODE.ARROW_DOWN) &&
                  t.nextSibling
                )
                  return (
                    a.node.isBlock(t.nextSibling)
                      ? a.selection.setAtStart(t.nextSibling)
                      : s(t).after(V.MARKERS),
                    a.selection.restore(),
                    !1
                  );
            ...
            a.events.on("mouseup", function () {
              ...
              e === a.selection.endElement() &&
                e &&
                "HR" === e.tagName &&
                (e.nextSibling &&
                  (a.node.isBlock(e.nextSibling)
                    ? a.selection.setAtStart(e.nextSibling)
                    : s(e).after(V.MARKERS)),
                a.selection.restore());
            });
        },
      ...
      return {
        _startEnter: function b(e) {
          ...
          if (g.node.isEmpty(n, !0) && r) {
            for (
              var a = "", s = "", l = e.parentNode;
              !g.node.isList(l) &&
              l.parentNode &&
              ("LI" !== l.parentNode.tagName || l.parentNode === n);
            ...
            for (
              c =
                l.parentNode && "LI" === l.parentNode.tagName
                  ? "".concat(s, "<li>").concat(V.MARKERS, "<br>").concat(a)
                  : i
                  ? ""
                      .concat(s, "<")
                      .concat(i, ">")
                      ...
                      .concat(i, ">")
                      .concat(a)
                  : "".concat(s + V.MARKERS, "<br>").concat(a);
            ...
            var d =
              g.node.openTagString(l) + m(l).html() + g.node.closeTagString(l);
            ...
            t = v(n);
            for (
              var u = "".concat(V.MARKERS, "<br>"), h = e.parentNode;
              h && "LI" !== h.tagName;
            ...
            t.parentNode && "LI" === t.parentNode.tagName
              ...
              : i
              ? m(t).after("<".concat(i, ">").concat(u, "</").concat(i, ">"))
              : m(t).after(u),
              m(n).remove();
          } else
            (t = v(n)).parentNode && "LI" === t.parentNode.tagName
              ? r
                ? m(t.parentNode).before(
                    "".concat(g.node.openTagString(n) + V.MARKERS, "<br></li>")
                  )
              ...
              : i
              ? m(t).before(
                  "<".concat(i, ">").concat(V.MARKERS, "<br></").concat(i, ">")
                )
              : m(t).before("".concat(V.MARKERS, "<br>")),
              m(n).remove();
        },
        _middleEnter: function c(e) {
          for (var t = C(e), n = "", r = e, o = "", i = "", a = !1; r !== t; ) {
            var s =
              "A" === (r = r.parentNode).tagName && g.cursor.isAtEnd(e, r)
                ? "fr-to-remove"
                : "";
            a ||
              r == t ||
              g.node.isBlock(r) ||
              ((a = !0), (o += V.INVISIBLE_SPACE)),
          ...
          (n =
            ...
            o +
            V.MARKERS +
            (g.opts.keepFormatOnDelete ? V.INVISIBLE_SPACE : "")),
            m(e).replaceWith('<span id="fr-break"></span>');
          var l =
            g.node.openTagString(t) + m(t).html() + g.node.closeTagString(t);
        ...
        _endEnter: function l(e) {
          for (var t = C(e), n = V.MARKERS, r = "", o = e, i = !1; o !== t; )
            if (
              !(o = o.parentNode).classList.contains("fr-img-space-wrap") &&
              !o.classList.contains("fr-img-space-wrap2")
            ) {
              var a =
                "A" === o.tagName && g.cursor.isAtEnd(e, o)
                  ? "fr-to-remove"
                  : "";
              i ||
                o === t ||
                g.node.isBlock(o) ||
                ((i = !0), (r += V.INVISIBLE_SPACE)),
          ...
          if (n) {
            ...
            r.length &&
              ...
              m(t)
                ...
                .each(function () {
                  this.parentNode === t &&
                    m(this).replaceWith(
                      m(this).html() + (g.node.isEmpty(this) ? "" : "<br>")
                    );
                });
            for (var o, i = g.node.contents(t)[0]; i && !g.node.isList(i); )
              (o = i.nextSibling), m(n).append(i), (i = o);
            ...
            if (
              ...
              l && 0 === m(t).find(g.html.blockTagsQuery()).length
                ? m(a).before(
                    "<".concat(l, ">").concat(m(t).html(), "</").concat(l, ">")
                  )
                : m(a).before(m(t).html());
            }
            m(t).remove(),
        ...
        _del: function f(e) {
          ...
          if (r) {
            ...
            for (
              var o, i = e, a = g.node.contents(r)[0];
              a && !g.node.isList(a);

            )
              (o = a.nextSibling), m(i).after(a), (i = a), (a = o);
            ...
            if (((s = s.nextSibling), g.node.isBlock(s)))
              V.NO_DELETE_TAGS.indexOf(s.tagName) < 0 &&
                (m(e).replaceWith(V.MARKERS),
    ...
    (V.MODULES.cursor = function (h) {
      ...
      function i(e) {
        return (
          ...
          (!!h.node.isBlock(e) ||
            ...
            0 === e.nextSibling.textContent.replace(/\u200b/g, "").length
              ? i(e.nextSibling)
              : !(
                  e.nextSibling &&
                  (!e.previousSibling ||
      ...
      function a(e) {
        return (
          ...
          (!!h.node.isBlock(e) ||
            ...
            0 === e.previousSibling.textContent.replace(/\u200b/g, "").length
              ? a(e.previousSibling)
              : !e.previousSibling &&
                (!(
                  e.previousSibling ||
                  !h.node.hasClass(e.parentNode, "fr-inner")
                ) ||
                  a(e.parentNode))))
        );
      }
      function u(e, t) {
        return (
          ...
          e.previousSibling.nodeType === Node.TEXT_NODE &&
          0 === e.previousSibling.textContent.replace(/\u200b/g, "").length
            ? u(e.previousSibling, t)
            : !e.previousSibling && (e.parentNode === t || u(e.parentNode, t)))
        );
      }
      function m(e, t) {
        return (
      ...
      function c(e) {
        return (
          0 < g(e).parentsUntil(h.$el, "LI").length &&
          0 === g(e).parentsUntil("LI", "TABLE").length
        );
      }
      function C(e, t) {
        var n = new RegExp(
      ...
      function v(e) {
        ...
        if (
          (!h.node.isBlock(n) || (n.lastChild && o && 0 <= r.indexOf(o))) &&
          h.node.isEditable(n)
        ) {
          for (
            t = h.node.contents(n);
            n.nodeType !== Node.TEXT_NODE &&
            !h.node.isDeletable(n) &&
            t.length &&
            h.node.isEditable(n);

          )
            (n = t[t.length - 1]), (t = h.node.contents(n));
          if (n.nodeType === Node.TEXT_NODE) {
            var i = n.textContent,
              a = i.length;
            if (i.length && "\n" === i[i.length - 1])
              return (
                (n.textContent = i.substring(0, a - 2)),
                0 === n.textContent.length && n.parentNode.removeChild(n),
                v(e)
              );
            if (h.opts.tabSpaces && i.length >= h.opts.tabSpaces)
              0 ===
                i
                  .substr(i.length - h.opts.tabSpaces, i.length - 1)
                  .replace(/ /g, "")
                  .replace(new RegExp(V.UNICODE_NBSP, "g"), "").length &&
                (a = i.length - h.opts.tabSpaces + 1);
            (n.textContent = i.substring(0, a - C(i))),
              h.opts.htmlUntouched &&
                !e.nextSibling &&
                n.textContent.length &&
                " " === n.textContent[n.textContent.length - 1] &&
                (n.textContent =
                  n.textContent.substring(0, n.textContent.length - 1) +
                  V.UNICODE_NBSP);
            var s = i.length !== n.textContent.length;
            if (0 === n.textContent.length)
              if (s && h.opts.keepFormatOnDelete)
                g(n).after(V.INVISIBLE_SPACE + V.MARKERS);
              else if (0 !== i.length && h.node.isBlock(n.parentNode))
                g(n).after(V.MARKERS);
              else if (
                ((2 != n.parentNode.childNodes.length ||
                  n.parentNode != e.parentNode) &&
                  1 != n.parentNode.childNodes.length) ||
                h.node.isBlock(n.parentNode) ||
                h.node.isElement(n.parentNode) ||
                !h.node.isDeletable(n.parentNode)
              ) {
                for (
                  var l, c = n;
                  !h.node.isElement(n.parentNode) &&
                  h.node.isEmpty(n.parentNode) &&
                  V.NO_DELETE_TAGS.indexOf(n.parentNode.tagName) < 0;

                )
                  if ("A" === (n = n.parentNode).tagName) {
                    var d = n.childNodes[0];
                    for (g(n).before(d), l = !0; 0 < d.childNodes.length; )
                      d = d.childNodes[0];
                ...
                var f = n.parentNode;
                n.parentNode.removeChild(n),
                  h.node.isEmpty(f) && g(f).html(V.INVISIBLE_SPACE + V.MARKERS);
              } else g(n.parentNode).after(V.MARKERS), g(n.parentNode).remove();
            else g(n).after(V.MARKERS);
          } else
            h.node.isDeletable(n)
              ? (g(n).after(V.MARKERS), g(n).remove())
              : e.nextSibling &&
                "BR" === e.nextSibling.tagName &&
                h.node.isVoid(n) &&
                "BR" !== n.tagName
              ? (g(e.nextSibling).remove(), g(e).replaceWith(V.MARKERS))
              : !1 !== h.events.trigger("node.remove", [g(n)]) &&
                (g(n).after(V.MARKERS), g(n).remove());
        } else if (
          V.NO_DELETE_TAGS.indexOf(n.tagName) < 0 &&
          (h.node.isEditable(n) || h.node.isDeletable(n))
        )
          if (h.node.isDeletable(n)) g(e).replaceWith(V.MARKERS), g(n).remove();
          else if (h.node.isEmpty(n) && !h.node.isList(n))
            g(n).remove(), g(e).replaceWith(V.MARKERS);
          else {
            for (
              h.node.isList(n) && (n = g(n).find("li").last().get(0)),
                (t = h.node.contents(n)) &&
                  "BR" === t[t.length - 1].tagName &&
                  g(t[t.length - 1]).remove(),
                t = h.node.contents(n);
              t && h.node.isBlock(t[t.length - 1]);
      ...
      function s(e) {
        ...
        if (n && "BLOCKQUOTE" === n.tagName) {
          var r = h.node.deepestParent(e, [
            g(e).parentsUntil(h.$el, "BLOCKQUOTE").get(0),
          ]);
          r && r.nextSibling && (n = r);
        }
        if (null !== n) {
          ...
          if (
            ...
            (h.node.isEditable(n) || h.node.isDeletable(n)) &&
            i &&
            V.NO_DELETE_TAGS.indexOf(i.tagName) < 0
          )
            if (h.node.isDeletable(i))
              g(i).remove(), g(e).replaceWith(V.MARKERS);
            else if (h.node.isBlock(i) && h.node.isEditable(i))
              if (h.node.isList(i))
                if (h.node.isEmpty(n, !0))
                  g(n).remove(), g(i).find("li").first().prepend(V.MARKERS);
                else {
                  var a = g(i).find("li").first();
                  "BLOCKQUOTE" === n.tagName &&
                    (o = h.node.contents(n)).length &&
                    h.node.isBlock(o[o.length - 1]) &&
                    (n = o[o.length - 1]),
                    0 === a.find("ul, ol").length &&
                      (g(e).replaceWith(V.MARKERS),
                      a
                        .find(h.html.blockTagsQuery())
                        .not("ol, ul, table")
                        .each(function () {
                          this.parentNode === a.get(0) &&
                            g(this).replaceWith(
                              g(this).html() +
                                (h.node.isEmpty(this) ? "" : "<br>")
                            );
                        }),
                      g(n).append(h.node.contents(a.get(0))),
                      a.remove(),
                      0 === g(i).find("li").length && g(i).remove());
                }
              else {
                if (
                  ((o = h.node.contents(i)).length &&
                    "BR" === o[0].tagName &&
                    g(o[0]).remove(),
                  ...
                  for (
                    o = h.node.contents(n);
                    o.length && h.node.isBlock(o[o.length - 1]);

                  )
                    (n = o[o.length - 1]), (o = h.node.contents(n));
                else if (
                  ...
                  for (
                    o = h.node.contents(i);
                    o.length && h.node.isBlock(o[0]);

                  )
                    (i = o[0]), (o = h.node.contents(i));
                g(e).replaceWith(V.MARKERS),
                  g(n).append(i.innerHTML),
                  g(i).remove();
              }
            else {
              for (
      ...
      function n(e) {
        ...
        if ("BR" === (n = n.nextSibling).tagName && h.node.isEditable(n))
          if (n.nextSibling) {
            if (
              h.node.isBlock(n.nextSibling) &&
              h.node.isEditable(n.nextSibling)
            ) {
              if (!(V.NO_DELETE_TAGS.indexOf(n.nextSibling.tagName) < 0))
                return void g(n).remove();
              (n = n.nextSibling), g(n.previousSibling).remove();
            }
          } else if (i(n)) {
            if (c(e)) h.cursorLists._del(e);
            else
              h.node.deepestParent(n) &&
                ((!h.node.isEmpty(h.node.blockParent(n)) ||
                  (h.node.blockParent(n).nextSibling &&
                    V.NO_DELETE_TAGS.indexOf(
                      h.node.blockParent(n).nextSibling.tagName
                    )) < 0) &&
                  g(n).remove(),
                s(e));
            return;
        ...
        if (!h.node.isBlock(n) && h.node.isEditable(n)) {
          for (
            ...
            (n = t[0]), (t = h.node.contents(n));
          n.nodeType === Node.TEXT_NODE
            ? (g(n).before(V.MARKERS),
              n.textContent.length &&
            ...
            : h.node.isDeletable(n)
            ? (g(n).before(V.MARKERS), g(n).remove())
            : !1 !== h.events.trigger("node.remove", [g(n)]) &&
              (g(n).before(V.MARKERS), g(n).remove()),
            g(e).remove();
        } else if (
          ...
          if (h.node.isDeletable(n)) g(e).replaceWith(V.MARKERS), g(n).remove();
          else if (h.node.isList(n))
            e.previousSibling
              ? (g(n).find("li").first().prepend(e),
                h.cursorLists._backspace(e))
              : (g(n).find("li").first().prepend(V.MARKERS), g(e).remove());
          else if (
            ((t = h.node.contents(n)) &&
              "BR" === t[0].tagName &&
              g(t[0]).remove(),
      ...
      function d() {
        for (
          var e = h.el.querySelectorAll("blockquote:empty"), t = 0;
          t < e.length;
          t++
        )
            ...
            m(e, o)
              ? ((r = h.html.defaultTag()),
                t
                  ...
                  : g(o).after("".concat(V.MARKERS, "<br>")),
                g(e).remove())
              : b(e, t, n),
            !1
          );
        if (null === o)
          (r = h.html.defaultTag()) && h.node.isElement(e.parentNode)
            ? g(e).replaceWith(
                "<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")
              )
            : !e.previousSibling ||
              g(e.previousSibling).is("br") ||
              e.nextSibling
            ? g(e).replaceWith("<br>".concat(V.MARKERS))
            : g(e).replaceWith("<br>".concat(V.MARKERS, "<br>"));
        else {
          var i = e,
            a = "";
          "PRE" != o.tagName || e.nextSibling || (t = !0),
            (h.node.isBlock(o) && !t) || (a = "<br/>");
          var s,
            l = "",
            c = "",
            d = "",
          ...
          (r = h.html.defaultTag()) &&
            ...
            ((d = "<".concat(r, ">")),
            (f = "</".concat(r, ">")),
            o.tagName === r.toUpperCase() &&
              (d = h.node.openTagString(g(o).clone().removeAttr("id").get(0))));
          do {
            if (
              ((i = i.parentNode), !t || i !== o || (t && !h.node.isBlock(o)))
            )
              if (
                ((l += h.node.closeTagString(i)), i === o && h.node.isBlock(o))
              )
                c = d + c;
              else {
                var p =
                  ("A" === i.tagName || h.node.hasClass(i, "fa")) && m(e, i)
                    ? "fr-to-remove"
                    : "";
          ...
          (a =
            ...
            a +
            c +
            (e.parentNode === o && h.node.isBlock(o) ? "" : V.INVISIBLE_SPACE) +
            V.MARKERS),
            h.node.isBlock(o) &&
              !g(o).find("*").last().is("br") &&
              g(o).append("<br/>"),
            ...
            g(e).remove(),
            (o.nextSibling && !h.node.isBlock(o.nextSibling)) ||
              h.node.isBlock(o) ||
              g(o).after("<br>"),
            (s = (s =
              !t && h.node.isBlock(o)
                ? h.node.openTagString(o) + g(o).html() + f
                : h.node.openTagString(o) +
                  g(o).html() +
                  h.node.closeTagString(o)).replace(
      ...
      function b(e, t, n) {
        ...
        if (null === r)
          h.html.defaultTag() && e.parentNode === h.el
            ? g(e).replaceWith(
                "<"
                  .concat(h.html.defaultTag(), ">")
                  .concat(V.MARKERS, "<br></")
                  .concat(h.html.defaultTag(), ">")
              )
            : ((e.nextSibling && !h.node.isBlock(e.nextSibling)) ||
                g(e).after("<br>"),
              g(e).replaceWith("<br>".concat(V.MARKERS)));
        else if (
          ...
          do {
            ...
            if (
              ...
              "BLOCKQUOTE" === r.tagName &&
                h.node.isEmpty(l) &&
                !h.node.hasClass(l, "fr-marker") &&
                g(l).contains(e) &&
                g(l).after(e),
              "BLOCKQUOTE" !== r.tagName || (!m(e, o) && !u(e, o)))
            )
              if (!t || o !== r || (t && !h.node.isBlock(r))) {
                a += h.node.closeTagString(o);
                var c =
                  ("A" == o.tagName && m(e, o)) || h.node.hasClass(o, "fa")
                    ? "fr-to-remove"
                    : "";
                s =
                  h.node.openTagString(
                    g(o).clone().addClass(c).removeAttr("id").get(0)
                  ) + s;
          ...
          if ("BLOCKQUOTE" === r.tagName)
            if (
              (e.previousSibling &&
                h.node.isBlock(e.previousSibling) &&
                e.nextSibling &&
                "BR" === e.nextSibling.tagName &&
                (g(e.nextSibling).after(e),
                e.nextSibling &&
                  "BR" === e.nextSibling.tagName &&
                  g(e.nextSibling).remove()),
              t)
          ...
          var p =
            h.node.openTagString(r) + g(r).html() + h.node.closeTagString(r);
      ...
      return {
        enter: function f(e) {
          ...
          for (var n = t.parentNode; n && !h.node.isElement(n); ) {
            if ("false" === n.getAttribute("contenteditable"))
              return g(t).replaceWith(V.MARKERS), h.selection.restore(), !1;
            if ("true" === n.getAttribute("contenteditable")) break;
            n = n.parentNode;
          }
          h.el.normalize();
          var r = !1;
          0 < g(t).parentsUntil(h.$el, "BLOCKQUOTE").length && (r = !0),
            g(t).parentsUntil(h.$el, "TD, TH").length && (r = !1),
            i(t)
              ? !c(t) || e || r
                ? l(t, e, r)
                : h.cursorLists._endEnter(t)
              : a(t)
              ? !c(t) || e || r
                ? (function s(e, t, n) {
                    var r,
                    ...
                    if (o && "TABLE" === o.tagName)
                      return g(o).find("td, th").first().prepend(e), s(e, t, n);
                    if (o && "BLOCKQUOTE" === o.tagName)
                      if (u(e, o)) {
                        if (!t)
                          return (
                            (r = h.html.defaultTag())
                              ...
                              : g(o).before("".concat(V.MARKERS, "<br>")),
                            g(e).remove(),
                            !1
                          );
                      } else m(e, o) ? l(e, t, !0) : b(e, t, !0);
                    if (null === o)
                      (r = h.html.defaultTag()) &&
                      h.node.isElement(e.parentNode)
                        ? g(e).replaceWith(
                            "<"
                              .concat(r, ">")
                              .concat(V.MARKERS, "<br></")
                      ...
                      if (((r = h.html.defaultTag()), h.node.isBlock(o)))
                        if (("PRE" === o.tagName && (t = !0), t))
                          g(e).remove(), g(o).prepend("<br>".concat(V.MARKERS));
                        else if (
                          (e.nextSibling && "IMG" == e.nextSibling.tagName) ||
                          (e.nextSibling &&
                            e.nextSibling.nextElementSibling &&
                            "IMG" == e.nextSibling.nextElementSibling)
                        )
                          g(e).replaceWith(
                            "<" +
                              h.html.defaultTag() +
                          ...
                          if (h.node.isEmpty(o, !0)) return l(e, t, n);
                          if (
                            h.opts.keepFormatOnDelete ||
                            "DIV" === o.tagName ||
                            "div" === h.html.defaultTag()
                          )
                            if (
                              (!h.opts.keepFormatOnDelete &&
                                "DIV" === o.tagName) ||
                              ...
                              for (
                                var i = e, a = V.INVISIBLE_SPACE;
                                i !== o && !h.node.isElement(i);

                              )
                                (i = i.parentNode),
                                  (a =
                                    h.node.openTagString(i) +
                                    a +
                                    h.node.closeTagString(i));
                              g(o).before(a);
                            }
                          else
                            g(o).before(
                ...
                : h.cursorLists._startEnter(t)
              : !c(t) || e || r
              ? b(t, e, r)
              : h.cursorLists._middleEnter(t),
            (function o() {
              h.$el.find(".fr-to-remove").each(function () {
                for (var e = h.node.contents(this), t = 0; t < e.length; t++)
                  e[t].nodeType === Node.TEXT_NODE &&
                    (e[t].textContent = e[t].textContent.replace(
                      /\u200B/g,
                      ""
                    ));
            ...
            h.html.fillEmptyBlocks(!0),
            h.opts.htmlUntouched ||
              (h.html.cleanEmptyTags(),
              h.clean.lists(),
              h.spaces.normalizeAroundCursor()),
            h.selection.restore(),
            h.$oel[0].offsetHeight > h.o_win.innerHeight &&
              h.o_win.scroll(0, h.$oel[0].scrollHeight);
        },
        backspace: function p() {
          ...
          if (r) {
            ...
            o &&
              o.length &&
              8203 === o.charCodeAt(o.length - 1) &&
              (1 === o.length
                ? g(r).remove()
                : (r.textContent = r.textContent.substr(0, o.length - C(o))));
          }
          return (
            i(t)
              ? c(t) && u(t, g(t).parents("li").first().get(0))
                ? h.cursorLists._backspace(t)
                : (e = v(t))
              : a(t)
              ? c(t) && u(t, g(t).parents("li").first().get(0))
                ? h.cursorLists._backspace(t)
                : (function l(e) {
                    for (
                      ...
                      !n.previousSibling &&
                      "BLOCKQUOTE" !== n.tagName &&
                      n.parentElement !== h.el &&
                      !h.node.hasClass(n.parentElement, "fr-inner") &&
                      V.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) < 0;

                    )
                      n = n.parentElement;
                    if (n && "BLOCKQUOTE" === n.tagName) {
                      var o = h.node.deepestParent(e, [
                        g(e).parentsUntil(h.$el, "BLOCKQUOTE").get(0),
                      ]);
                    ...
                    if (null !== n) {
                      ...
                      if (h.node.isBlock(n) && h.node.isEditable(n))
                        if (a && V.NO_DELETE_TAGS.indexOf(a.tagName) < 0) {
                          if (h.node.isDeletable(a))
                            g(a).remove(), g(e).replaceWith(V.MARKERS);
                          else if (h.node.isEditable(a))
                            if (h.node.isBlock(a))
                              if (h.node.isEmpty(a) && !h.node.isList(a))
                                g(a).remove(),
                                  g(e).after(
                                    h.opts.keepFormatOnDelete
                                      ? V.INVISIBLE_SPACE
                                ...
                                if (
                                  (h.node.isList(a) &&
                                    (a = g(a).find("li").last().get(0)),
                                  (i = h.node.contents(a)).length &&
                                    "BR" === i[i.length - 1].tagName &&
                                    g(i[i.length - 1]).remove(),
                                  "BLOCKQUOTE" === a.tagName &&
                                    "BLOCKQUOTE" !== n.tagName)
                                )
                                  for (
                                    i = h.node.contents(a);
                                    i.length && h.node.isBlock(i[i.length - 1]);
                                  ...
                                  for (
                                    i = h.node.contents(r);
                                    i.length && h.node.isBlock(i[0]);

                                  )
                                    (r = i[0]), (i = h.node.contents(r));
                                if (h.node.isEmpty(n))
                                  g(e).remove(), h.selection.setAtEnd(a, !0);
                                else {
                                  g(e).replaceWith(V.MARKERS);
                                  var s = a.childNodes;
                                  h.node.isBlock(s[s.length - 1])
                                    ? g(s[s.length - 1]).append(r.innerHTML)
                                    : g(a).append(r.innerHTML);
                                }
                                g(r).remove(),
                                  h.node.isEmpty(n) && g(n).remove();
                              }
                            else
                              g(e).replaceWith(V.MARKERS),
                                "BLOCKQUOTE" === n.tagName &&
                                a.nodeType === Node.ELEMENT_NODE
                                  ? g(a).remove()
                                  : (g(a).after(
                                      h.node.isEmpty(n) ? "" : g(n).html()
                                    ),
                                    g(n).remove(),
                                    "BR" === a.tagName && g(a).remove());
                        } else
                          a ||
                            (n &&
                            "BLOCKQUOTE" === n.tagName &&
                            0 ===
                              ...
                              : h.node.isEmpty(n) &&
                                n.parentNode &&
                                h.node.isEditable(n.parentNode) &&
                                n.parentNode != h.el &&
                                g(n.parentNode).remove());
                    }
                  })(t)
              : (e = v(t)),
            g(t).remove(),
        ...
        del: function r() {
          ...
          if (!e) return !1;
          if ((h.el.normalize(), i(e)))
            if (c(e))
              if (0 === g(e).parents("li").first().find("ul, ol").length)
                h.cursorLists._del(e);
              else {
                var t = g(e)
                  .parents("li")
                  .first()
                  ...
                  .find("li")
                  .first();
                (t = t.find(h.html.blockTagsQuery()).get(-1) || t).prepend(e),
                  h.cursorLists._backspace(e);
              }
            else s(e);
          else a(e), n(e);
          g(e).remove(),
            d(),
            h.html.fillEmptyBlocks(!0),
            h.opts.htmlUntouched || (h.html.cleanEmptyTags(), h.clean.lists()),
            h.spaces.normalizeAroundCursor(),
            h.selection.restore();
        },
        isAtEnd: m,
    ...
    (V.MODULES.data = function (f) {
      ...
      function g() {
        if (
          ...
          return !1;
        f.$wp.prepend(N(p(N(T)))),
          (v = f.$wp.find("> div").first()),
          (b = v.find("> a")),
          "rtl" === f.opts.direction &&
            v.css("left", "auto").css("right", 0).attr("direction", "rtl"),
          e++;
      }
      function m(e) {
        for (
      ...
      var v,
        ...
        M = (function () {
          for (
            ...
            e < n.length - 1 &&
            -1 === document.cookie.indexOf("".concat(r, "=").concat(r));
          ...
          return (
            (document.cookie = ""
              .concat(r, "=;expires=Thu, 01 Jan 1970 00:00:01 GMT;domain=")
              .concat(t, ";")),
            (t || "").replace(/(^\.*)|(\.*$)/g, "")
          );
        })(),
      ...
      return {
        _init: function x() {
          ...
          for (var n, r, o, i = !(f.ul = !0), a = 0, s = 0; s < e.length; s++) {
            var l =
                ((r = e[s]),
                4 === (o = (N(r) || "").split("|")).length && "V3" === o[0]
                  ? [o[1], o[3], o[2]]
                  : [null, null, ""]),
              c = l[2];
            if (
              c === N(p(N("LGnD1KNZf1CPBYCAZB-8F3UDSLLSG1VFf1A3C2=="))) ||
              0 <= c.indexOf(M, c.length - M.length) ||
              m(M) ||
              C()
            ) {
              if (
                (null !== (n = l[1]) &&
                  !(0 == n.indexOf("TRIAL")
                    ? ((n = new Date(n.replace(/TRIAL/, ""))),
                      new Date(n) < new Date() && ((E = y), 1))
                    : new Date(n) < new Date(N(S)))) ||
                !(0 < (M || "").length) ||
                m(M) ||
                C()
              ) {
          ...
          t.events.disableBlur(),
            t.$wp
              ? (t.$el.attr("contenteditable", !1),
                t.$el.addClass("fr-disabled").attr("aria-disabled", !0))
    ...
    (V.MODULES.format = function (T) {
      ...
      function m(e, t, n) {
        if (e) {
          ...
          if (e) {
            if (T.node.isBlock(e) && "HR" !== e.tagName)
              return (
                T.node.hasClass(e.firstChild, "fr-marker")
                  ? m(e.firstChild.nextSibling, t, n)
                  : m(e.firstChild, t, n),
                !1
              );
            ...
            for (
              var o = e;
              o &&
              !M(o).hasClass("fr-marker") &&
              0 === M(o).find(".fr-marker").length &&
              "UL" !== o.tagName &&
              "OL" !== o.tagName;

            ) {
              var i = o;
              if (T.node.isBlock(o) && "HR" !== e.tagName)
                return m(o.firstChild, t, n), !1;
              (o = o.nextSibling), r.append(i);
            }
            if (o) {
              if (
                M(o).find(".fr-marker").length ||
                "UL" === o.tagName ||
                "OL" === o.tagName
              )
                m(o.firstChild, t, n);
                ...
                var a,
                  s = T.selection.blocks(),
                  l = s.length;
                for (a = 0; a < l; a++)
                  s[a] != o.parentNode &&
                    s[a].childNodes.length &&
                    s[a].childNodes[0] != o.parentNode &&
                    ((o = s[a].childNodes[1] || s[a].childNodes[0]),
                    (r = M(f(t, n)).insertBefore(o)).append(o));
              }
            } else {
              for (
                var c = r.get(0).parentNode;
                c && !c.nextSibling && !T.node.isElement(c);
      ...
      function n(e, t) {
        ...
        if (
          ...
          T.selection.save(),
            m(
              T.$el.find('.fr-marker[data-type="true"]').length &&
                T.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling,
              e,
              t
            );
          do {
            for (
              r = T.$el.find("".concat(N(e, t), " > ").concat(N(e, t))), n = 0;
              n < r.length;
              n++
            )
          ...
          for (n = 0; n < o.length; n++) {
            var i = M(o[n]);
            !0 === i.data("type")
              ? A(i.get(0).nextSibling, N(e, t)) && i.next().prepend(i)
              : A(i.get(0).previousSibling, N(e, t)) && i.prev().append(i);
          }
          T.selection.restore();
        }
      }
      function x(e, t, n, r) {
        ...
        if (e.parents(t).length || void 0 === t) {
          ...
          for (
            ;
            !(
              T.node.isBlock(l.parent().get(0)) ||
              (void 0 !== t && A(l.get(0), N(t, n)))
            );

          )
            (a += T.node.closeTagString(l.get(0))),
              (s = T.node.openTagString(l.get(0)) + s),
              (l = l.parent());
          ...
          return (
            ...
            (i = l
              ...
              .replace(
                /<span id="mark"><\/span>/,
                a +
                  T.node.closeTagString(l.get(0)) +
                  s +
                  c +
                  a +
                  T.node.openTagString(l.get(0)) +
                  s
              )),
            l.replaceWith(
              T.node.openTagString(l.get(0)) +
      ...
      function r(e, t) {
        ...
        for (var r = !0; r; ) {
          ...
          for (var o = T.$el.find(".fr-marker"), i = 0; i < o.length; i++) {
            ...
            if (
              (a.attr("data-cloned") ||
                n ||
                ((s = a.clone().removeClass("fr-marker").addClass("fr-clone")),
                a.data("type") && "true" === a.data("type").toString()
                  ? a.attr("data-cloned", !0).after(s)
                  : a.attr("data-cloned", !0).before(s)),
              x(a, e, t, n))
            ) {
              r = !0;
              break;
        ...
        !(function y(e, t, n, r) {
          for (var o = T.node.contents(e.get(0)), i = 0; i < o.length; i++) {
            ...
            if (
              (a.innerHTML &&
                8203 == a.innerHTML.charCodeAt() &&
                a.tagName.toLocaleLowerCase() == n &&
                a.childNodes.length < 2 &&
                (a.outerHTML = a.innerHTML),
              T.node.hasClass(a, "fr-marker"))
            )
              t = (t + 1) % 2;
            else if (t)
              if (0 < M(a).find(".fr-marker").length) t = y(M(a), t, n, r);
                ...
                for (
                  var s = M(a).find(n || "*:not(br)"), l = s.length - 1;
                  0 <= l;
                  l--
                ) {
                  var c = s[l];
                ...
                A(a, N(n, r))
                  ? T.node.isBlock(a) ||
                    T.node.hasClass(a, "fr-clone") ||
                    (a.outerHTML = a.innerHTML)
                  : void 0 === n &&
                    a.nodeType === Node.ELEMENT_NODE &&
                    T.node.isBlock(a) &&
                    "TABLE" !== a.tagName &&
                    T.node.clearAttributes(a);
              }
          ...
          n &&
            T.$el
              .find(".fr-marker")
              .before(V.INVISIBLE_SPACE)
              .after(V.INVISIBLE_SPACE),
        ...
        if (l) {
          var c = T.node.blockParent(l),
            ...
            p = f.startOffset,
            u = f.endOffset;
          T.selection.text().replace(/\u200B/g, "").length ||
            (function S(e, t) {
              if (e && t) {
                if (
                  (e.isSameNode(t)
          ...
          if (l.nodeType === Node.TEXT_NODE) {
            if (!d || (!T.selection.text().length && p === u)) {
              ...
              if (T.browser.msie) {
                ...
                T.selection.get().removeAllRanges(),
                  m.setStart(l, g),
                  m.setEnd(l, g),
                  T.selection.get().addRange(m);
      ...
      function t(e, t) {
        ...
        if (T.selection.isCollapsed()) {
          ...
          if (
            ...
            if (T.node.isEmpty(l.get(0)))
              (s = M(T.doc.createElement("span"))
                .attr("style", "".concat(e, ": ").concat(t, ";"))
                .html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS))),
                l.replaceWith(s);
            else {
              var c = {};
              (c["style*"] = "".concat(e, ":")),
                x(r, "span", c, !0),
                (r = T.$el.find(".fr-marker")),
                t
                  ? ((s = M(T.doc.createElement("span"))
                      .attr("style", "".concat(e, ": ").concat(t, ";"))
                      .html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS))),
                    r.replaceWith(s))
                  : r.replaceWith(V.INVISIBLE_SPACE + V.MARKERS);
            }
            T.html.cleanEmptyTags();
          } else
            T.node.isEmpty(l.get(0)) && l.is("span")
              ? (r.replaceWith(V.MARKERS), l.css(e, t))
              : ((s = M(
                  '<span style="'
                    .concat(e, ": ")
                    .concat(t, ';">')
                    .concat(V.INVISIBLE_SPACE)
                    .concat(V.MARKERS, "</span>")
                )),
                r.replaceWith(s));
          s && C(s, e, t);
        } else {
          if (
            ...
            null === t ||
              ("color" === e &&
                0 < T.$el.find(".fr-marker").parents("u, a").length))
          ) {
            ...
            for (n = 0; n < d.length; n++)
              if (
                ...
                for (
                  ;
                  T.node.isFirstSibling(r.get(0)) &&
                  !r.parent().is(T.$el) &&
                  !T.node.isElement(r.parent().get(0)) &&
                  !T.node.isBlock(r.parent().get(0));
          ...
          for (
            var f = T.$el.find('.fr-marker[data-type="true"]').get(0)
              .nextSibling;
            f.firstChild;
          ...
          for (
            t && (p.style = "".concat(e, ": ").concat(t, ";")),
              m(f, "span", p),
              T.$el.find(".fr-marker + .fr-unprocessed").each(function () {
              ...
              (t || "").match(/\dem$/) &&
                T.$el.find("span.fr-unprocessed").removeClass("fr-unprocessed");
            0 < T.$el.find("span.fr-unprocessed").length;
        ...
        !(function g() {
          var e;
          for (; 0 < T.$el.find(".fr-split:empty").length; )
            T.$el.find(".fr-split:empty").remove();
          T.$el.find(".fr-split").removeClass("fr-split"),
            T.$el.find('[style=""]').removeAttr("style"),
            T.$el.find('[class=""]').removeAttr("class"),
            T.html.cleanEmptyTags();
          for (var t = T.$el.find("span"), n = t.length - 1; 0 <= n; n--) {
            var r = t[n];
            (r.attributes && 0 !== r.attributes.length) ||
              M(r).replaceWith(r.innerHTML);
          }
          T.el.normalize();
          ...
          for (e = 0; e < o.length; e++) {
            var i = M(o[e]),
              a = M(o[e]).prev();
            i.get(0).previousSibling === a.get(0) &&
              T.node.openTagString(i.get(0)) ===
                T.node.openTagString(a.get(0)) &&
              (i.prepend(a.html()), a.remove());
          }
          T.$el.find("span[style] span[style]").each(function () {
            if (0 <= M(this).attr("style").indexOf("font-size")) {
              ...
              0 <= e.attr("style").indexOf("background-color") &&
                (M(this).attr(
                  "style",
                  "".concat(M(this).attr("style"), ";").concat(e.attr("style"))
                ),
                x(M(this), "span[style]", {}, !1));
            }
          }),
            T.el.normalize(),
            T.selection.restore();
      ...
      function C(e, t, n) {
        var r,
          o,
          i,
          a = e.parentsUntil(T.$el, "span[style]"),
          s = [];
        for (r = a.length - 1; 0 <= r; r--)
          (o = a[r]),
            (i = t),
            0 === M(o).attr("style").indexOf("".concat(i, ":")) ||
              0 <= M(o).attr("style").indexOf(";".concat(i, ":")) ||
              0 <= M(o).attr("style").indexOf("; ".concat(i, ":")) ||
              s.push(a[r]);
        if ((a = a.not(s)).length) {
          for (
            ...
            (p = p.parentNode),
              M(p).addClass("fr-split"),
              (l += T.node.closeTagString(p)),
              (c =
                T.node.openTagString(M(p).clone().addClass("fr-split").get(0)) +
                c),
              a.get(0) !== p &&
                ((d += T.node.closeTagString(p)),
                (f =
                  T.node.openTagString(
                    M(p).clone().addClass("fr-split").get(0)
                  ) + f)),
              a.get(0) !== p;
      ...
      function o(e, t) {
        ...
        if (
          ...
          for (; !T.node.isBlock(r.parentNode) && !r.nextSibling; )
            r = r.parentNode;
          r.nextSibling && (r = r.nextSibling);
        }
        for (
          var o = r;
          o && o.nodeType === Node.ELEMENT_NODE && !A(o, N(e, t));

        )
          o = o.firstChild;
        if (o && o.nodeType === Node.ELEMENT_NODE && A(o, N(e, t))) return !0;
        var i = r;
        for (
          i && i.nodeType !== Node.ELEMENT_NODE && (i = i.parentNode);
          i && i.nodeType === Node.ELEMENT_NODE && i !== T.el && !A(i, N(e, t));
    ...
    (V.MODULES.spaces = function (c) {
      function r(e, t) {
        ...
        if (!c.html.isPreformatted(i)) {
          t &&
            ((o = o.replace(/[\f\n\r\t\v ]{2,}/g, " ")),
            (r && "BR" !== r.tagName && !c.node.isBlock(r)) ||
              !(
                c.node.isBlock(i) ||
                (c.node.isLink(i) && !i.nextSibling) ||
                c.node.isElement(i)
              ) ||
              (o = o.replace(/[\f\n\r\t\v ]{1,}$/g, "")),
            (n && "BR" !== n.tagName && !c.node.isBlock(n)) ||
              !(
                c.node.isBlock(i) ||
                (c.node.isLink(i) && !i.previousSibling) ||
                c.node.isElement(i)
              ) ||
              (o = o.replace(/^[\f\n\r\t\v ]{1,}/g, "")),
            (c.node.isBlock(r) || c.node.isBlock(n)) &&
              (o = o.replace(/^[\f\n\r\t\v ]{1,}/g, "")),
            " " === o &&
              ((n && c.node.isVoid(n)) || (r && c.node.isVoid(r))) &&
              !((n && r && c.node.isVoid(n)) || (r && n && c.node.isVoid(r))) &&
              (o = "")),
            ((!n && c.node.isBlock(r)) || (!r && c.node.isBlock(n))) &&
              c.node.isBlock(i) &&
              i !== c.el &&
              (o = o.replace(/^[\f\n\r\t\v ]{1,}/g, "")),
          ...
          for (var s = "", l = 0; l < o.length; l++)
            32 != o.charCodeAt(l) ||
            (0 !== l && 32 != s.charCodeAt(l - 1)) ||
            (((c.opts.enter !== V.ENTER_BR && c.opts.enter !== V.ENTER_DIV) ||
              !((n && "BR" === n.tagName) || (r && "BR" === r.tagName))) &&
              ((n && r && c.node.isVoid(n)) || (n && r && c.node.isVoid(r))))
              ? (s += o[l])
              : (s += V.UNICODE_NBSP);
          (!r ||
            (r && c.node.isBlock(r)) ||
            (r &&
              r.nodeType === Node.ELEMENT_NODE &&
              c.win.getComputedStyle(r) &&
              "block" === c.win.getComputedStyle(r).display)) &&
            (!c.node.isVoid(n) ||
              (n &&
                -1 !== ["P", "DIV", "BR"].indexOf(n.tagName) &&
                -1 !== a.indexOf(c.opts.enter))) &&
            (s = s.replace(/ $/, V.UNICODE_NBSP)),
            !n ||
              c.node.isVoid(n) ||
              c.node.isBlock(n) ||
      ...
      function l(e, t) {
        if (
          ...
          if (e.nodeType === Node.TEXT_NODE) r(e, t);
            ...
            for (
              var n = c.doc.createTreeWalker(
                e,
                NodeFilter.SHOW_TEXT,
                c.node.filter(function (e) {
                  ...
                  return (
                    null !==
                      e.textContent.match(
                        /([ \u00A0\f\n\r\t\v]{2,})|(^[ \u00A0\f\n\r\t\v]{1,})|([ \u00A0\f\n\r\t\v]{1,}$)/g
                      ) && !c.node.hasClass(e.parentNode, "fr-marker")
                  );
                }),
                !1
              );
      ...
      return {
        ...
        normalizeAroundCursor: function d() {
          for (
            var e = [], t = c.el.querySelectorAll(".fr-marker"), n = 0;
            n < t.length;
            n++
          ) {
            for (
              var r = null,
                o = c.node.blockParent(t[n]),
                i = (r = o || t[n]).nextSibling,
                a = r.previousSibling;
              i && "BR" === i.tagName;
    ...
    (V.START_MARKER = '<span class="fr-marker" data-id="0" data-type="true" style="display: none; line-height: 0;">'.concat(
      (V.INVISIBLE_SPACE = "&#8203;"),
      "</span>"
    )),
    (V.END_MARKER = '<span class="fr-marker" data-id="0" data-type="false" style="display: none; line-height: 0;">'.concat(
      V.INVISIBLE_SPACE,
      "</span>"
    )),
    ...
    (V.MODULES.markers = function (d) {
      ...
      function l() {
        ...
        try {
          ...
          var n = e.cloneRange(),
            r = e.cloneRange();
          n.collapse(!0);
          var o = f(d.doc.createElement("SPAN"))
            .addClass("fr-marker")
            .attr("style", "display: none; line-height: 0;")
            .html(V.INVISIBLE_SPACE)
            .get(0);
          if ((n.insertNode(o), (o = d.$el.find("span.fr-marker").get(0)))) {
            for (
              var i = o.nextSibling;
              i && i.nodeType === Node.TEXT_NODE && 0 === i.textContent.length;
      ...
      return {
          ...
          try {
            ...
            if (
                  ...
                  return (
                    n
                      ...
                      .attr(
                        "style",
                        "display: ".concat(
                          d.browser.safari ? "none" : "inline-block",
                          "; line-height: 0;"
                        )
                      )
                      .html(V.INVISIBLE_SPACE),
              ...
              for (
                i = (r = d.$el
                  .find(
                    'span.fr-marker[data-type="true"][data-id="'.concat(n, '"]')
                  )
                  .get(0)).nextSibling;
                i &&
            ...
            if (!0 === t && !e.collapsed) {
              for (; !d.node.isElement(r.parentNode) && !i; )
                -1 < /\bfa\b/g.test(r.parentNode.className) &&
                "I" === r.parentNode.tagName
                  ? f(r.parentNode).before(r)
            ...
            if (!1 === t && !e.collapsed) {
              if (
                ...
                for (
                  o = [i];
                  (i = o[o.length - 1]),
                    (o = d.node.contents(i))[o.length - 1] &&
                      d.node.isBlock(o[o.length - 1]);

                );
                f(i).append(f(r));
              }
              ((r.parentNode &&
                0 <= ["TD", "TH"].indexOf(r.parentNode.tagName)) ||
                (!r.previousSibling && d.node.isBlock(r.parentElement))) &&
                (r.parentNode.previousSibling && !r.previousSibling
                  ...
                  : 0 <= ["TD", "TH"].indexOf(r.parentNode.tagName) &&
                    ...
                    (r.parentNode.previousSibling
                      ...
                      : r.parentNode.parentNode &&
                        r.parentNode.parentNode.previousSibling &&
                        f(r.parentNode.parentNode.previousSibling).append(r)));
            }
            var s = d.$el
              .find(
        ...
        split: function a() {
          ...
          if (
            (t ||
              ((t = d.node.blockParent(e)) && "LI" !== t.tagName && (t = null)),
            t)
          )
            if (d.node.isBlock(t) && d.node.isEmpty(t))
              ...
              d.node.isEmpty(t.parentNode)
                ? f(t).replaceWith('<span class="fr-marker"></span>')
                : f(t).append('<span class="fr-marker"></span>');
            else if (d.cursor.isAtStart(e, t))
              f(t).before('<span class="fr-marker"></span>'), f(e).remove();
            else if (d.cursor.isAtEnd(e, t))
              f(t).after('<span class="fr-marker"></span>'), f(e).remove();
            else {
              for (
                var n = e, r = "", o = "";
                (n = n.parentNode),
              ...
              (i = i.replace(
                /<span id="fr-break"><\/span>/g,
                "".concat(r, '<span class="fr-marker"></span>').concat(o)
              )),
                f(t).replaceWith(i);
            }
    ...
    (V.MODULES.selection = function (E) {
      ...
      function s() {
        ...
        return (
          E.win.getSelection
            ...
            : E.doc.selection && (e = E.doc.selection.createRange().text),
          e.toString()
        );
      }
      function L() {
          ...
          for (t = 0; t < n.length; t++)
            if (n[t].startContainer !== E.doc || E.browser.msie) {
              ...
              if (
                ((void 0 !== i && i) ||
                  !o ||
                  (y(".fr-marker").remove(), E.selection.setAtEnd(E.el)),
                E.el.normalize(),
                E.browser.safari && !o)
              )
                try {
                  (e = E.doc.createRange()).setStartAfter(i),
                    e.setEndBefore(a),
                    r.push(e);
                } catch (s) {}
            }
      ...
      function M() {
        ...
        for (e = 0; e < t.length; e++) {
          var r = y(t[e]).data("id"),
            ...
            i = E.doc.createRange(),
            a = E.$el.find(
              '.fr-marker[data-type="false"][data-id="'.concat(r, '"]')
            );
          (E.browser.msie || E.browser.edge) &&
          ...
          if (0 < a.length) {
            ...
            try {
              for (
                var l = !1, c = o.nextSibling, d = null;
                c &&
              ...
              if (o.nextSibling === a || a.nextSibling === o) {
                for (
                  var p = o.nextSibling === a ? o : a,
                    u = p === o ? a : o,
                    h = p.previousSibling;
                  h && h.nodeType === Node.TEXT_NODE && 0 === h.length;
                ...
                if (h && h.nodeType === Node.TEXT_NODE)
                  for (
                    ...
                    h &&
                    h.previousSibling &&
                    h.previousSibling.nodeType === Node.TEXT_NODE;
                ...
                for (
                  var g = u.nextSibling;
                  g && g.nodeType === Node.TEXT_NODE && 0 === g.length;
                ...
                if (g && g.nodeType === Node.TEXT_NODE)
                  for (
                    ...
                    g &&
                    g.nextSibling &&
                    g.nextSibling.nodeType === Node.TEXT_NODE;
                ...
                if (
                  (h && (E.node.isVoid(h) || E.node.isBlock(h)) && (h = null),
                  g && (E.node.isVoid(g) || E.node.isBlock(g)) && (g = null),
                  h &&
                    g &&
                  ...
                  (h.textContent += g.textContent),
                    y(g).remove(),
                    E.opts.htmlUntouched || E.spaces.normalize(h),
                    i.setStart(h, m),
                    i.setEnd(h, m),
                    (l = !0);
                } else
                  !h && g && g.nodeType === Node.TEXT_NODE
                    ? (y(o).remove(),
                      y(a).remove(),
                      E.opts.htmlUntouched || E.spaces.normalize(g),
                      (s = y(E.doc.createTextNode("\u200b")).get(0)),
                      y(g).before(s),
                      i.setStart(g, 0),
                      i.setEnd(g, 0),
                      (l = !0))
              ...
              if (!l) {
                var C = void 0,
                  v = void 0;
                (v =
                  (E.browser.chrome || E.browser.edge) && o.nextSibling === a
                    ? ((C = N(a, i, !0) || i.setStartAfter(a)),
                      N(o, i, !1) || i.setEndBefore(o))
                    : (o.previousSibling === a && (a = (o = a).nextSibling),
                      (a.nextSibling && "BR" === a.nextSibling.tagName) ||
                        (!a.nextSibling && E.node.isBlock(o.previousSibling)) ||
                        (o.previousSibling &&
                          "BR" === o.previousSibling.tagName) ||
                        ((o.style.display = "inline"),
                        (a.style.display = "inline"),
                        (s = y(E.doc.createTextNode("\u200b")).get(0))),
                      (C =
                        N(o, i, !0) || (y(o).before(s) && i.setStartBefore(o))),
                      N(a, i, !1) || (y(a).after(s) && i.setEndAfter(a)))),
                  "function" == typeof C && C(),
                  "function" == typeof v && v();
              }
            } catch (b) {}
          ...
          ? ((r = o.textContent.length),
            n
              ? ((i.textContent = o.textContent + i.textContent),
                y(o).remove(),
                y(e).remove(),
                E.opts.htmlUntouched || E.spaces.normalize(i),
                function () {
                  t.setStart(i, r);
                })
              : ((o.textContent += i.textContent),
                y(i).remove(),
                y(e).remove(),
                E.opts.htmlUntouched || E.spaces.normalize(o),
                function () {
                  t.setEnd(o, r);
                }))
      ...
      function o(e) {
        ...
        if (E.win.getSelection) {
          ...
          E.doc.selection &&
            "Control" !== E.doc.selection.type &&
            ((n = (t = E.doc.selection.createRange()).duplicate()).moveToElementText(
              e
            ),
      ...
      function x(e, t) {
        ...
        n &&
          ...
          y(e).html(n.replace(/\u200b/g, ""));
        for (var r = E.node.contents(e), o = 0; o < r.length; o++)
          r[o].nodeType !== Node.ELEMENT_NODE
            ? y(r[o]).remove()
            : (x(r[o], 0 === o), 0 === o && (t = !1));
        if (e.nodeType === Node.TEXT_NODE) {
          var i = y(document.createElement("span"))
      ...
      function u() {
        try {
          if (!E.$wp) return !1;
          for (
            var e = f(0).commonAncestorContainer;
            e && !E.node.isElement(e);
      ...
      function r(e, t) {
        ...
        for (
          ...
          n &&
          (E.node.isBlock(n) ||
            (t && !E.node.isVoid(n) && n.nodeType === Node.ELEMENT_NODE));
      ...
      function i(e, t) {
        ...
        for (
          r.setAttribute("id", "fr-sel-markers"), r.innerHTML = V.MARKERS;
          e.parentNode &&
          E.opts.htmlAllowedEmptyTags &&
          0 <= E.opts.htmlAllowedEmptyTags.indexOf(e.tagName.toLowerCase());
      ...
      return {
            ...
            if (e.rangeCount) {
              ...
              if (
                ...
                for (
                  ;
                  r.childNodes.length &&
                  r.childNodes[0].nodeType === Node.ELEMENT_NODE;
              ...
              if (
                ...
                if (0 < r.childNodes.length && r.childNodes[n.startOffset]) {
                  ...
                  !n.collapsed &&
                    r.nextSibling &&
                    r.nextSibling.nodeType === Node.ELEMENT_NODE &&
                    (t = r.nextSibling) &&
                    t.textContent.replace(/\u200B/g, "") ===
                      s().replace(/\u200B/g, "") &&
                    ((r = t), (o = !0));
          ...
          try {
            if (e.rangeCount) {
              ...
              if (r.nodeType === Node.ELEMENT_NODE) {
                ...
                y(r.childNodes[n.endOffset]).text() === s()
                  ? ((r = r.childNodes[n.endOffset]), (o = !0))
                  : !n.collapsed &&
                    r.previousSibling &&
                    r.previousSibling.nodeType === Node.ELEMENT_NODE
                  ? (t = r.previousSibling) &&
                    t.textContent.replace(/\u200B/g, "") ===
                      s().replace(/\u200B/g, "") &&
                    ((r = t), (o = !0))
                  : !n.collapsed &&
                    0 < r.childNodes.length &&
                    r.childNodes[n.endOffset] &&
                    (t = r.childNodes[n.endOffset].previousSibling).nodeType ===
                      Node.ELEMENT_NODE &&
                    t &&
                    t.textContent.replace(/\u200B/g, "") ===
                      s().replace(/\u200B/g, "") &&
                  ...
                  !o &&
                    0 < r.childNodes.length &&
                    y(r.childNodes[r.childNodes.length - 1]).text() === s() &&
                    ["BR", "IMG", "HR"].indexOf(
                      r.childNodes[r.childNodes.length - 1].tagName
                    ) < 0 &&
              ...
              for (
                ...
                r.previousSibling.nodeType === Node.ELEMENT_NODE &&
                (r = r.previousSibling);
                r.nodeType !== Node.ELEMENT_NODE && r.parentNode;
        ...
        isFull: function d() {
          ...
          for (e = 0; e < t.length; e++)
            (t[e].nextSibling || "IMG" === t[e].tagName) &&
              (t[
                e
              ].innerHTML = '<span class="fr-mk" style="display: none;">&nbsp;</span>'.concat(
                t[e].innerHTML
              ));
          var n = !1,
            r = o(E.el);
        ...
        remove: function w() {
          ...
          function t(e) {
            for (
              ...
              t && t.nodeType === Node.TEXT_NODE && 0 === t.textContent.length;
          ...
          for (e = 0; e < r.length; e++)
            for (
              ...
              !(
                t(o) ||
                E.node.isBlock(o.parentNode) ||
                E.$el.is(o.parentNode) ||
                E.node.hasClass(o.parentNode, "fr-inner")
              );
          ...
          for (e = 0; e < i.length; e++) {
            for (
              ...
              !(
                n(a) ||
                E.node.isBlock(a.parentNode) ||
                E.$el.is(a.parentNode) ||
                E.node.hasClass(a.parentNode, "fr-inner")
              );
            ...
            a.parentNode &&
              E.node.isBlock(a.parentNode) &&
              E.node.isEmpty(a.parentNode) &&
              !E.$el.is(a.parentNode) &&
              !E.node.hasClass(a.parentNode, "fr-inner") &&
              E.opts.keepFormatOnDelete &&
              y(a.parentNode).after(a);
          }
          if (
            (function b() {
            ...
            !(function L(e, t) {
              ...
              0 <= ["TD", "TH"].indexOf(e.get(0).tagName) &&
                ...
                (E.node.hasClass(n[0], "fr-marker") ||
                  ("BR" == n[0].tagName &&
                    E.node.hasClass(n[0].nextElementSibling, "fr-marker"))) &&
                e.attr("data-del-cell", !0);
              for (var r = 0; r < n.length; r++) {
                var o = n[r];
                E.node.hasClass(o, "fr-marker")
                  ? (t = (t + 1) % 2)
                  : t
                  ? 0 < y(o).find(".fr-marker").length
                    ? (t = L(y(o), t))
                    : ["TD", "TH"].indexOf(o.tagName) < 0 &&
                      !E.node.hasClass(o, "fr-inner")
                    ? !E.opts.keepFormatOnDelete ||
                      0 < E.$el.find("[data-first]").length ||
                      E.node.isVoid(o)
                      ? y(o).remove()
                      : x(o)
                    : E.node.hasClass(o, "fr-inner")
                    ? 0 === y(o).find(".fr-inner").length
                      ? y(o).html("<br>")
                      : y(o).find(".fr-inner").filter(O).html("<br>")
                    : (y(o).empty(), y(o).attr("data-del-cell", !0))
                  : 0 < y(o).find(".fr-marker").length && (t = L(y(o), t));
              }
              return t;
            })(E.$el, 0);
            ...
            if (s.length)
              E.$el.find(".fr-marker").remove(),
                s
                  .append(V.INVISIBLE_SPACE + V.MARKERS)
              ...
              for (
                E.$el
                  ...
                  .filter(function () {
                    return (
                      0 < y(this).find("[data-del-cell]").length &&
                      y(this).find("[data-del-cell]").length ===
                        y(this).find("td, th").length
                    );
                  })
                  .remove(),
                  E.$el.find("[data-del-cell]").removeAttr("data-del-cell"),
                  r = E.$el.find('.fr-marker[data-type="true"]'),
                  e = 0;
                e < r.length;
                e++
              ) {
                ...
                if (d) {
                  if (l && (!c || c !== d)) {
                    ...
                    if (
                      (f &&
                        0 <= ["UL", "OL"].indexOf(f.tagName) &&
                        (u = !(f = null)),
                      p &&
                        0 <= ["UL", "OL"].indexOf(p.tagName) &&
                        (h = !(p = null)),
                      y(l).after(d),
                      f !== p)
                    )
                      if (null !== f || u)
                        if (
                          null !== p ||
                          h ||
                          0 !== y(f).parentsUntil(E.$el, "table").length
                        )
                          f &&
                            p &&
                            0 === y(f).parentsUntil(E.$el, "table").length &&
                            0 === y(p).parentsUntil(E.$el, "table").length &&
                            !y(f).contains(p) &&
                            !y(p).contains(f) &&
                            (y(f).append(y(p).html()), y(p).remove());
                        else {
                        ...
                        m
                          ? (y(m).after(y(p).html()), y(p).remove())
                          : 0 === y(p).parentsUntil(E.$el, "table").length &&
                            (y(l).next().after(y(p).html()), y(p).remove());
                      }
                  }
                } else (d = y(l).clone().attr("data-type", !1)), y(l).after(d);
              }
          }
          E.$el.find("li:empty").remove(),
            E.opts.keepFormatOnDelete || E.html.fillEmptyBlocks(),
            E.html.cleanEmptyTags(!0),
            E.opts.htmlUntouched ||
              (E.clean.lists(),
              E.$el.find("li:empty").append("<br>"),
              E.spaces.normalize());
          ...
          void 0 !== C &&
            ...
            !C.nextSibling &&
            v.previousSibling &&
            "BR" === v.previousSibling.tagName &&
            E.node.isElement(C.parentNode) &&
            E.node.isElement(v.parentNode) &&
            E.$el.append("<br>"),
            M();
        },
        blocks: function h(e) {
          ...
          if (u() && o.rangeCount) {
            ...
            for (t = 0; t < i.length; t++) {
              ...
              (E.node.isBlock(s) || E.node.hasClass(s, "fr-inner")) &&
                r.indexOf(s) < 0 &&
                r.push(s),
                (n = E.node.blockParent(s)) && r.indexOf(n) < 0 && r.push(n);
              for (var c = [], d = s; d !== l && d !== E.el; )
                c.indexOf(d) < 0 && d.children && d.children.length
                  ? (c.push(d), (d = d.children[0]))
                  : d.nextSibling
                  ? (d = d.nextSibling)
                  : d.parentNode && ((d = d.parentNode), c.push(d)),
                  E.node.isBlock(d) &&
                    c.indexOf(d) < 0 &&
                    r.indexOf(d) < 0 &&
                    (d !== l || 0 < a.endOffset) &&
              ...
              E.node.isBlock(l) &&
                ...
                0 < a.endOffset &&
                r.push(l),
                (n = E.node.blockParent(l)) && r.indexOf(n) < 0 && r.push(n);
            }
          }
        ...
        setBefore: function g(e, t) {
          ...
          return n
            ? (E.node.isBlock(n)
                ? i(n)
                : "BR" === n.tagName
                ? y(n).before(V.MARKERS)
                : y(n).after(V.MARKERS),
              !0)
            : !!t && (E.node.isBlock(e) ? r(e) : y(e).before(V.MARKERS), !0);
        },
        setAfter: function m(e, t) {
          ...
          for (
            ...
            n = n.nextSibling;
          return n
            ? (E.node.isBlock(n) ? r(n) : y(n).before(V.MARKERS), !0)
            : !!t && (E.node.isBlock(e) ? i(e) : y(e).after(V.MARKERS), !0);
        },
        rangeElement: p,
      };
    }),
    Object.assign(V.DEFAULTS, { language: null }),
    (V.LANGUAGE = {}),
    ...
    Object.assign(V.DEFAULTS, { placeholderText: "Type something" }),
    (V.MODULES.placeholder = function (f) {
      var p = f.$;
      function e() {
        f.$placeholder ||
          (function d() {
            (f.$placeholder = p(f.doc.createElement("SPAN")).addClass(
              "fr-placeholder"
            )),
        ...
        f.$wp.addClass("show-placeholder"),
          f.$placeholder
            .css({
              marginTop:
                Math.max(f.helpers.getPX(f.$el.css("margin-top")), t) +
                (e || 0),
              paddingTop: Math.max(
            ...
            .text(
              f.language.translate(
                f.opts.placeholderText || f.$oel.attr("placeholder") || ""
              )
            ),
    ...
    (V.MODULES.html = function (O) {
      var h = O.$;
      function d() {
        return O.opts.enter === V.ENTER_P
          ? "p"
          : O.opts.enter === V.ENTER_DIV
          ? "div"
          : O.opts.enter === V.ENTER_BR
          ? null
          : void 0;
      }
      function s(e, t) {
      ...
      function i(e) {
        ...
        var l = p();
        for (
          l += ",".concat(V.VOID_ELEMENTS.join(",")),
            l += ", .fr-inner",
            l += ",".concat(
              O.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),"),
              ":not(.fr-marker)"
            ),
            t = r.length - 1;
          0 <= t;
          ...
          if (
            !(
              (r[t].textContent &&
                0 < r[t].textContent.replace(/\u200B|\n/g, "").length) ||
              0 < r[t].querySelectorAll(l).length
            )
          ) {
            for (
              var c = O.node.contents(r[t]), d = !1, f = 0;
              f < c.length;
              f++
            )
              if (
      ...
      function e(e) {
        ...
        (r = h.merge(r, O.opts.htmlAllowedEmptyTags)),
          (r =
            void 0 === e
              ? h.merge(r, V.BLOCK_TAGS)
              : h.merge(r, V.NO_DELETE_TAGS)),
          (t = O.el.querySelectorAll(
            "*:empty:not(".concat(
              r.join("):not("),
        ...
        do {
          ...
          for (var o = 0; o < t.length; o++)
            (0 !== t[o].attributes.length &&
              void 0 === t[o].getAttribute("href")) ||
              (t[o].parentNode.removeChild(t[o]), (n = !0));
          t = O.el.querySelectorAll(
            "*:empty:not(".concat(
              r.join("):not("),
              "):not(.fr-marker):not(template)"
      ...
      function a(e, t) {
        ...
        if ((t && (n = "div"), n)) {
          for (
            var r = O.doc.createDocumentFragment(),
              o = null,
              i = !1,
              a = e.firstChild,
              s = !1;
            ...
            if (
              ...
              (O.node.isBlock(a) ||
                (0 <=
                  O.opts.htmlDoNotWrapTags.indexOf(a.tagName.toLowerCase()) &&
                  !O.node.hasClass(a, "fr-marker")))
            )
              (o = null), r.appendChild(a.cloneNode(!0));
            else if (
              a.nodeType !== Node.ELEMENT_NODE &&
              ...
              null === o
                ? ((o = O.doc.createElement(n)),
                  (s = !0),
                  t &&
                    (o.setAttribute("class", "fr-temp-div"),
                    o.setAttribute("data-empty", !0)),
                  o.appendChild(a.cloneNode(!0)),
                  r.appendChild(o))
                : !1 === i &&
                  (o.appendChild(O.doc.createElement("br")),
                  t &&
                    (o.setAttribute("class", "fr-temp-div"),
                    o.setAttribute("data-empty", !0))),
                (o = null);
      ...
      function n(e) {
        if (
          ...
          return !1;
        for (
          var t = O.doc.createTreeWalker(
            e,
            NodeFilter.SHOW_TEXT,
            O.node.filter(function (e) {
              return (
                null !==
                e.textContent.match(/([ \n]{2,})|(^[ \n]{1,})|([ \n]{1,}$)/g)
              );
          ...
          if (!s(n.parentNode, !0)) {
            var r =
                O.node.isBlock(n.parentNode) || O.node.isElement(n.parentNode),
              o = n.textContent
                .replace(/(?!^)( ){2,}(?!$)/g, " ")
                .replace(/\n/g, " ")
                .replace(/^[ ]{2,}/g, " ")
            ...
            if (r) {
              var i = n.previousSibling,
                a = n.nextSibling;
              i && a && " " === o
                ? (o = O.node.isBlock(i) && O.node.isBlock(a) ? "" : " ")
                : (i || (o = o.replace(/^ */, "")),
                  a || (o = o.replace(/ *$/, "")));
            }
            n.textContent = o;
      ...
      function w(e) {
        ...
        return (
          t &&
            (n = "<!DOCTYPE "
              .concat(t.name)
              .concat(t.publicId ? ' PUBLIC "'.concat(t.publicId, '"') : "")
              .concat(!t.publicId && t.systemId ? " SYSTEM" : "")
              .concat(t.systemId ? ' "'.concat(t.systemId, '"') : "", ">")),
          n
        );
      }
      function c(e) {
        ...
        if (
          t &&
          (O.node.isBlock(t) || O.node.isElement(t)) &&
          ...
          !t ||
            ...
            e.previousSibling ||
            e.nextSibling ||
            !O.node.isDeletable(e.parentNode) ||
            c(e.parentNode);
      }
      function g() {
        O.opts.htmlUntouched ||
          (e(),
          t(),
          n(),
          O.spaces.normalize(null, !0),
      ...
      function o() {
        O.node.isEmpty(O.el) &&
          (null !== d()
            ? O.el.querySelector(p()) ||
              O.el.querySelector(
                "".concat(
                  O.opts.htmlDoNotWrapTags.join(":not(.fr-marker),"),
                  ":not(.fr-marker)"
                )
              ) ||
              (O.core.hasFocus()
            ...
            : O.el.querySelector("*:not(.fr-marker):not(br)") ||
              (O.core.hasFocus()
                ? (O.$el.html("".concat(V.MARKERS, "<br/>")),
                  O.selection.restore())
                : O.$el.html("<br/>")));
      }
      function m(e, t) {
      ...
      function $(e) {
        ...
        return (n += (
          (e = (e = e.replace(/[*\s+>~]/g, " ")).replace(/[#.]/g, " ")).match(
            /([^\s+>~.[:]+)/g
          ) || []
        ).length);
      }
      function k(e) {
        if (
          (O.events.trigger("html.processGet", [e]),
          e &&
            e.getAttribute &&
            "" === e.getAttribute("class") &&
            e.removeAttribute("class"),
      ...
      function _() {
        for (
          var e = O.el.querySelectorAll("input, textarea"), t = 0;
          t < e.length;
          t++
        )
          ("checkbox" !== e[t].type && "radio" !== e[t].type) ||
            (e[t].checked
              ? e[t].setAttribute("checked", e[t].checked)
              : O.$(e[t]).removeAttr("checked")),
            e[t].getAttribute("value") &&
              e[t].setAttribute("value", e[t].value);
      }
      function f(e) {
      ...
      function u(e) {
        var t = null;
        if (
          (void 0 === e && (t = O.selection.element()),
          O.opts.keepFormatOnDelete)
        )
          return !1;
        var n,
          r,
          o = t
            ...
            : 0;
        if (
          (O.el.textContent.match(/\u200B/g) || []).length -
            O.el.querySelectorAll(".fr-marker").length ===
          o
        )
          return !1;
        do {
      ...
      return {
          ...
          for (var n = 0; n < t.length; n++) {
            ...
            "false" === r.getAttribute("contenteditable") ||
              ...
              ("TABLE" !== r.tagName &&
                ...
                "UL" !== r.tagName &&
                "OL" !== r.tagName &&
                r.appendChild(O.doc.createElement("br")));
          }
          if (O.browser.msie && O.opts.enter === V.ENTER_BR) {
            var o = O.node.contents(O.el);
            o.length &&
              o[o.length - 1].nodeType === Node.TEXT_NODE &&
              O.$el.append("<br>");
          }
        },
        cleanEmptyTags: e,
        ...
        set: function T(e) {
          ...
          if (O.opts.fullPage) {
            ...
            b(O.$el, "".concat(c, "\n").concat(o)),
              ...
              O.$html.attr(f),
              O.iframe_document.doctype.parentNode.replaceChild(
                (function u(e, t) {
                  var n = e.match(
                    /<!DOCTYPE ?([^ ]*) ?([^ ]*) ?"?([^"]*)"? ?"?([^"]*)"?>/i
                  );
                  return n
                    ? t.implementation.createDocumentType(n[1], n[3], n[4])
                    : t.implementation.createDocumentType("html");
                })(d, O.iframe_document),
                O.iframe_document.doctype
              );
          } else b(O.$el, r);
          ...
          O.edit.on(),
            ...
            g(),
            O.opts.useClasses ||
              (O.$el.find("[fr-original-class]").each(function () {
                this.setAttribute(
                  "class",
        ...
        get: function B(e, t) {
          ...
          if ((_(), !O.opts.useClasses && !t)) {
            var l = new RegExp(
              "^".concat(O.opts.htmlIgnoreCSSProperties.join("$|^"), "$"),
              "gi"
            );
            for (r = 0; r < O.doc.styleSheets.length; r++) {
              ...
              try {
                (c = O.doc.styleSheets[r].cssRules),
                  O.doc.styleSheets[r].ownerNode &&
                    "STYLE" === O.doc.styleSheets[r].ownerNode.nodeType &&
                    (d = 1);
              } catch (x) {}
              if (c)
                for (var f = 0, p = c.length; f < p; f++)
                  if (c[f].selectorText && 0 < c[f].style.cssText.length) {
                    var u = c[f].selectorText
                    ...
                    for (o = 0; o < h.length; o++) {
                      !h[o].getAttribute("fr-original-style") &&
                      h[o].getAttribute("style")
                        ? (h[o].setAttribute(
                          ...
                          i.push(h[o]))
                        : h[o].getAttribute("fr-original-style") ||
                          (h[o].setAttribute("fr-original-style", ""),
                          i.push(h[o])),
                        a[h[o]] || (a[h[o]] = {});
                      for (
                        var g = 1e3 * d + $(c[f].selectorText),
                          m = c[f].style.cssText.split(";"),
                          C = 0;
                        C < m.length;
                        C++
                      ) {
                        ...
                        if (
                          ...
                          (a[h[o]][v] ||
                            ((a[h[o]][v] = 0) <=
                              ...
                              (a[h[o]][v] = 1e4)),
                          g >= a[h[o]][v] &&
                            ((a[h[o]][v] = g), m[C].trim().length))
                        ) {
                          var b = m[C].trim().split(":");
                          b.splice(0, 1),
                            s.push([h[o], v.trim(), b.join(":").trim(), g]);
                        }
                      }
                    }
                  }
            ...
            for (r = 0; r < i.length; r++)
              if (
                ...
                0 <
                  (i[r].getAttribute("fr-original-style") || "").trim().length)
              ) {
          ...
          if (O.node.isEmpty(O.el))
            O.opts.fullPage &&
              ((n = w(O.iframe_document)),
              (n += "<html"
                .concat(O.node.attributes(O.$html.get(0)), ">")
                .concat(
                  O.$html.find("head").get(0).outerHTML,
                  "<body></body></html>"
                )));
          ...
          if (!O.opts.useClasses && !t)
            for (r = 0; r < i.length; r++)
              i[r].getAttribute("fr-original-class") &&
                (i[r].setAttribute(
                  "class",
                  i[r].getAttribute("fr-original-class")
                ),
                i[r].removeAttribute("fr-original-class")),
                null !== i[r].getAttribute("fr-original-style") &&
                void 0 !== i[r].getAttribute("fr-original-style")
                  ? (0 !== i[r].getAttribute("fr-original-style").length
                      ? i[r].setAttribute(
                          "style",
                          i[r].getAttribute("fr-original-style")
                        )
                      : i[r].removeAttribute("style"),
                    i[r].removeAttribute("fr-original-style"))
                  : i[r].removeAttribute("style");
          O.opts.fullPage &&
        ...
        getSelected: function M() {
          function e(e, t) {
            for (
              ;
              t &&
              (t.nodeType === Node.TEXT_NODE || !O.node.isBlock(t)) &&
              !O.node.isElement(t) &&
              !O.node.hasClass(t, "fr-inner");

            )
              t &&
                t.nodeType !== Node.TEXT_NODE &&
                h(e).wrapInner(
                  O.node.openTagString(t) + O.node.closeTagString(t)
                ),
                (t = t.parentNode);
            t && e.innerHTML === t.innerHTML
              ...
              : -1 != t.innerText.indexOf(e.innerHTML) &&
                (e.innerHTML =
                  O.node.openTagString(t) +
                  t.innerHTML +
                  O.node.closeTagString(t));
          }
          var t,
            n,
            r = "";
          if ("undefined" != typeof O.win.getSelection) {
            O.browser.mozilla &&
              (O.selection.save(),
              1 < O.$el.find('.fr-marker[data-type="false"]').length &&
                (O.$el
                ...
                O.$el
                  ...
                  .attr("data-id", "0"),
                O.$el.find(".fr-marker").not('[data-id="0"]').remove()),
              O.selection.restore());
            for (var o = O.selection.ranges(), i = 0; i < o.length; i++) {
              ...
              a.appendChild(o[i].cloneContents()),
                e(
                  ...
                  (n = null),
                  O.win.getSelection
                    ? (t = O.win.getSelection()) &&
                      t.rangeCount &&
                      (n = t.getRangeAt(0).commonAncestorContainer).nodeType !==
                        Node.ELEMENT_NODE &&
                      (n = n.parentNode)
                    : (t = O.doc.selection) &&
                      "Control" !== t.type &&
                  ...
                  null !== n &&
                  (0 <= h(n).parents().toArray().indexOf(O.el) || n === O.el)
                    ? n
                    : null)
                ),
                0 < h(a).find(".fr-element").length && (a = O.el),
                (r += a.innerHTML);
            }
          } else
            "undefined" != typeof O.doc.selection &&
              "Text" === O.doc.selection.type &&
              (r = O.doc.selection.createRange().htmlText);
          return r;
        },
        insert: function N(e, t, n) {
          var r;
          if (
            (O.selection.isCollapsed() || O.selection.remove(),
            (r = t ? e : O.clean.html(e)),
            e.indexOf('class="fr-marker"') < 0 &&
              (r = (function a(e) {
                var t = O.doc.createElement("div");
                return (
                  (t.innerHTML = e), O.selection.setAtEnd(t, !0), t.innerHTML
                );
              })(r)),
            O.node.isEmpty(O.el) && !O.opts.keepFormatOnDelete && f(r))
          )
            O.el.innerHTML = r;
          else {
            var o = O.markers.insert();
            if (o) {
              O.node.isLastSibling(o) &&
                h(o).parent().hasClass("fr-deletable") &&
                h(o).insertAfter(h(o).parent());
              var i = O.node.blockParent(o);
              if (
                (f(r) || n) &&
                (O.node.deepestParent(o) || (i && "LI" === i.tagName))
              ) {
                if (
                  (i &&
                    "LI" === i.tagName &&
                    (r = (function s(e) {
                      ...
                      for (
                        var n = t.querySelectorAll(
                            ":scope > ".concat(O.html.defaultTag())
                          ),
                          r = n.length - 1;
                        0 <= r;
                        r--
                        ...
                        var o = n[r];
                        O.node.isBlock(o.previousSibling) ||
                          (o.previousSibling &&
                            !O.node.isEmpty(o) &&
                            h("<br>").insertAfter(o.previousSibling),
                          (o.outerHTML = o.innerHTML));
                      }
                      return t.innerHTML;
                    })(r)),
        ...
        unwrap: function A() {
          O.$el.find("div.fr-temp-div").each(function () {
            this.previousSibling &&
              ...
              h(this).before("<br>"),
              h(this).attr("data-empty") ||
              !this.nextSibling ||
              (O.node.isBlock(this.nextSibling) &&
                !h(this.nextSibling).hasClass("fr-temp-div"))
                ? h(this).replaceWith(h(this).html())
                : h(this).replaceWith("".concat(h(this).html(), "<br>"));
          }),
            O.$el
              .find(".fr-temp-div")
        ...
        cleanBRs: function R() {
          for (
            var e = O.el.getElementsByTagName("br"), t = 0;
            t < e.length;
            t++
          )
            c(e[t]);
        ...
        _init: function H() {
          O.events.$on(O.$el, "mousemove", "span.fr-word-select", function (e) {
            ...
            O.$wp &&
              (O.events.on("mouseup", L),
              O.events.on("keydown", L),
    ...
    (V.MODULES.keys = function (d) {
      ...
      function h(e) {
        ["INPUT", "BUTTON", "TEXTAREA"].indexOf(e.target && e.target.tagName) <
          0 && e.preventDefault(),
          e.stopPropagation(),
          "" !== d.selection.text() ||
          (!d.selection.isCollapsed() && "IMG" == d.selection.element().tagName)
            ? d.selection.remove()
            : d.cursor.del(),
          d.placeholder.refresh();
      }
      function e() {
        if (d.browser.mozilla && d.selection.isCollapsed() && !p) {
          ...
          t &&
            ...
            (d.selection.save(), d.spaces.normalize(), d.selection.restore());
        }
      }
      function t() {
        d.selection.isFull() &&
          setTimeout(function () {
            ...
            e
              ? d.$el.html(
                  "<".concat(e, ">").concat(V.MARKERS, "<br/></").concat(e, ">")
                )
              : d.$el.html("".concat(V.MARKERS, "<br/>")),
              d.selection.restore(),
              d.placeholder.refresh(),
      ...
      function m(e, t) {
        if (
          (-1 < e.innerHTML.indexOf("<span") ||
            -1 < e.parentElement.innerHTML.indexOf("<span") ||
            -1 < e.parentElement.parentElement.innerHTML.indexOf("<span")) &&
          (e.classList.contains("fr-img-space-wrap") ||
            e.parentElement.classList.contains("fr-img-space-wrap") ||
            e.parentElement.parentElement.classList.contains(
              "fr-img-space-wrap"
            ))
        ) {
          if (o(e.parentElement).is("p")) {
            ...
            return (
              (n = n.replace(/<br>/g, "")).length < 1
                ? e.parentElement.insertAdjacentHTML("afterbegin", "&nbsp;")
                : "&nbsp;" != n && " " != n && "Backspace" == t.key
                ? u(t)
                : "&nbsp;" != n && " " != n && "Delete" == t.key && h(t),
              !0
            );
          }
          if (o(e).is("p")) {
      ...
      function s(e) {
        ...
        if (
          ((d.selection.isFull() &&
            !d.opts.keepFormatOnDelete &&
            !d.placeholder.isVisible()) ||
            (o && d.placeholder.isVisible() && d.opts.keepFormatOnDelete)) &&
          (r || o) &&
          (g(), !b(n))
        )
        ...
        if (n === V.KEYCODE.ENTER)
          e.shiftKey ||
          t.classList.contains("fr-inner") ||
          t.parentElement.classList.contains("fr-inner")
            ? (function i(e) {
                e.preventDefault(),
                  e.stopPropagation(),
                  d.opts.multiLine &&
                    ...
                    if (n) {
                      ...
                      "A" === n.parentNode.tagName
                        ...
                        : (r &&
                          ...
                          160 === r.textContent.charCodeAt(0)
                            ? (r.textContent += " ")
      ...
      function l() {
        if (!d.$wp) return !0;
        var e;
        d.opts.height || d.opts.heightMax
          ? ((e = d.position.getBoundingRect().top),
            (d.helpers.isIOS() || d.helpers.isAndroid()) &&
          ...
          : ((e = d.position.getBoundingRect().top),
            ...
            (d.helpers.isIOS() || d.helpers.isAndroid()) &&
              (e -= d.helpers.scrollTop()),
            d.opts.iframe &&
              ((e += d.$iframe.offset().top), (e -= d.helpers.scrollTop())),
            (e += d.opts.toolbarStickyOffset) > d.o_win.innerHeight - 20 &&
              o(d.o_win).scrollTop(
                e + d.helpers.scrollTop() - d.o_win.innerHeight + 20
              ),
            (e = d.position.getBoundingRect().top),
            d.opts.toolbarBottom || (e -= d.opts.toolbarStickyOffset),
            (d.helpers.isIOS() || d.helpers.isAndroid()) &&
      ...
      function c(e) {
        ...
        if (
          (e &&
            d.helpers.isIOS() &&
            e.which === V.KEYCODE.ENTER &&
            d.doc.execCommand("undo"),
          !d.selection.isCollapsed())
        )
          return !0;
        ...
        if (
          ...
          !d.helpers.isIOS() &&
          (e.which === V.KEYCODE.ENTER ||
            e.which === V.KEYCODE.BACKSPACE ||
            (37 <= e.which && e.which <= 40 && !d.browser.msie))
        )
          try {
            l();
          } catch (r) {}
      ...
      function L(e) {
        ...
        if (
          ...
          (!b(t) &&
            t !== V.KEYCODE.DELETE &&
            t !== V.KEYCODE.BACKSPACE &&
            t !== V.KEYCODE.ENTER &&
            t !== V.KEYCODE.IME)
        )
          return !0;
        n || ((r = d.snapshot.get()), d.undo.canDo() || d.undo.saveStep()),
          clearTimeout(n),
      ...
      function E(e) {
        ...
        r && n
          ? (d.undo.saveStep(r), (r = null))
          : (void 0 !== t && 0 !== t) || r || n || d.undo.saveStep();
      }
      function y(e) {
        ...
        try {
          return (
            ...
            (e.childNodes &&
              ...
              ("false" === e.childNodes[0].getAttribute("contenteditable") ||
                d.node.hasClass(e.childNodes[0], "fr-img-caption")))
          );
        } catch (t) {
          return !1;
        }
      ...
      function S(e) {
        ...
        return (
          r &&
            ...
            (r = r.closest("table")),
          !d.node.isEditable(e.target) ||
          (r && "false" === r.getAttribute("contenteditable"))
            ? d.toolbar.disable()
            : d.toolbar.enable(),
          !(!e.target || e.target === d.el) ||
            0 === t.length ||
            void (t[0].offsetHeight + t[0].offsetTop <= e.offsetY
              ? y(t[t.length - 1]) &&
                (n
                  ...
                  : d.$el.append("".concat(V.MARKERS, "<br>")),
                d.selection.restore(),
                l())
              : e.offsetY <= 10 &&
                y(t[0]) &&
                (n
                  ...
                  : d.$el.prepend("".concat(V.MARKERS, "<br>")),
                d.selection.restore(),
                l()))
        );
      }
    ...
    (V.MODULES.paste = function (N) {
      ...
      function n(e, t) {
        try {
          N.win.localStorage.setItem("fr-copied-html", e),
            N.win.localStorage.setItem("fr-copied-text", t);
        } catch (n) {}
      }
      function e(e) {
        var t = N.html.getSelected();
        n(t, O(N.doc.createElement("div")).html(t).text()),
          "cut" === e.type &&
            (N.undo.saveStep(),
            setTimeout(function () {
              N.selection.save(),
      ...
      function t(e) {
        ...
        if (
          ...
          !1 === N.events.trigger("paste.before", [e]))
        )
          return e.preventDefault(), !1;
        if (e && e.clipboardData && e.clipboardData.getData) {
          ...
          if (
            ...
            /text\/html/.test(t) && !N.browser.safari
              ? (a = e.clipboardData.getData("text/html"))
              : /text\/rtf/.test(t) && N.browser.safari
              ? (a = s)
              : /public.rtf/.test(t) &&
                N.browser.safari &&
                (a = e.clipboardData.getData("text/rtf")),
            (A = e.clipboardData.getData("text")),
            "" !== a)
          )
            return (
              d(),
        ...
        return (
          (function o() {
            N.selection.save(),
              ...
              i
                ? (i.html(""),
                  N.browser.edge && N.opts.iframe && N.$el.append(i))
                : ((i = O(
                  ...
                  N.browser.webkit || N.browser.mozilla
                    ? (i.css("top", N.$sc.scrollTop()), N.$el.after(i))
                    : N.browser.edge && N.opts.iframe
                    ? N.$el.append(i)
                    : N.$box.after(i),
      ...
      function r(e) {
        ...
        if (e && e.dataTransfer && e.dataTransfer.getData) {
          ...
          if (
            ...
            /text\/html/.test(t)
              ? (a = e.dataTransfer.getData("text/html"))
              : /text\/rtf/.test(t) && N.browser.safari
              ? (a = s)
              : /text\/plain/.test(t) &&
                !this.browser.mozilla &&
                (a = N.html
                  .escapeEntities(e.dataTransfer.getData("text/plain"))
                  .replace(/\n/g, "<br>")),
            "" !== a)
          ) {
            N.keys.forceUndo(),
      ...
      function d() {
        N.opts.iframe && N.$el.attr("contenteditable", "true"),
          N.browser.edge && N.opts.iframe && N.$box.after(i),
          x || (N.keys.forceUndo(), (x = N.snapshot.get())),
          a ||
            ((a = i.get(0).innerHTML),
            (A = i.text()),
            N.selection.restore(),
        ...
        t && "string" == typeof t && (a = t),
          (!e || (e && !1 !== N.events.trigger("paste.wordPaste", [a]))) &&
            o(a, e);
      }
      function w(e) {
        for (var t = "", n = 0; n++ < e; ) t += "&nbsp;";
      ...
      function o(e, t, n) {
          ...
          0 <= e.indexOf("<style") &&
            ...
            (e = (e = (e =
              ...
              e.replace(
                ...
                "$1"
              )).replace(/<pre(?:[\w\W]*?)>(?:[\w\W]*?)<\/pre>/g, function (e) {
              return e.replace(/ \n/g, "<br />");
            }))
              .replace(/ \n/g, " ")
              .replace(/\n /g, " ")
          ...
          if (
            ((l = (function E() {
              ...
              return !(
                !e ||
                !A ||
                (A.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") !==
                  e.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") &&
                  A.replace(/\s/g, "") !== e.replace(/\s/g, ""))
              );
            })()) && (e = N.win.localStorage.getItem("fr-copied-html")),
            l)
          )
            e = N.clean.html(
              e,
              N.opts.pasteDeniedTags,
              N.opts.pasteDeniedAttrs
            );
          else {
            var c = N.opts.htmlAllowedStyleProps;
            (N.opts.htmlAllowedStyleProps = N.opts.pasteAllowedStyleProps),
              (N.opts.htmlAllowComments = !1),
              (e = (e = (e = e.replace(
                /<span class="Apple-tab-span">\s*<\/span>/g,
                w(N.opts.tabSpaces || 4)
              )).replace(
                /<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g,
                function (e, t) {
                  return w(t.length * (N.opts.tabSpaces || 4));
                }
              )).replace(/\t/g, w(N.opts.tabSpaces || 4))),
              (e = N.clean.html(
                e,
                N.opts.pasteDeniedTags,
                N.opts.pasteDeniedAttrs
              )),
              (N.opts.htmlAllowedStyleProps = c),
              (N.opts.htmlAllowComments = !0),
              (e = (e = (e = $(e)).replace(/\r/g, ""))
                .replace(/^ */g, "")
                .replace(/ *$/g, ""));
          }
            ...
            (e = (function y(e) {
              ...
              for (t = 0; t < a.length; t++) {
                ...
                if (l && "LI" === l.tagName) {
                  ...
                  c || ((c = document.createElement("ul")), l.appendChild(c)),
                    c.appendChild(s);
        ...
        if (("string" == typeof d && (e = d), "" !== e)) {
          ...
          0 <= (f.innerHTML = e).indexOf("<body>")
            ? (N.html.cleanBlankSpaces(f), N.spaces.normalize(f, !0))
            : N.spaces.normalize(f);
          ...
          if ((m && O(m).parentsUntil(N.el, "ul, ol").length && (C = !0), C)) {
            var v = f.children;
            1 === v.length &&
              0 <= ["OL", "UL"].indexOf(v[0].tagName) &&
              (v[0].outerHTML = v[0].innerHTML);
          }
          if (!s) {
          ...
          if (N.opts.enter === V.ENTER_BR)
            for (r = (o = f.querySelectorAll("p, div")).length - 1; 0 <= r; r--)
              0 === (i = o[r]).attributes.length &&
                (i.outerHTML =
                  i.innerHTML +
                  (i.nextSibling && !N.node.isEmpty(i) ? "<br>" : ""));
          else if (N.opts.enter === V.ENTER_DIV)
            for (r = (o = f.getElementsByTagName("p")).length - 1; 0 <= r; r--)
              0 === (i = o[r]).attributes.length &&
                (i.outerHTML = "<div>".concat(i.innerHTML, "</div>"));
          else
            N.opts.enter === V.ENTER_P &&
              1 === f.childNodes.length &&
              "P" === f.childNodes[0].tagName &&
              0 === f.childNodes[0].attributes.length &&
              (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
          (e = f.innerHTML),
            l &&
              (e = (function T(e) {
                var t,
                ...
                var r = n.querySelectorAll(
                  "*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not("
                    .concat(V.VOID_ELEMENTS.join("):not("), "):not(")
                    .concat(N.opts.htmlAllowedEmptyTags.join("):not("), ")")
                );
                for (; r.length; ) {
                  for (t = 0; t < r.length; t++)
      ...
      function $(e) {
        ...
        for (
          ...
          var o = r[r.length - 1];
          if (N.html.defaultTag() && "div" !== N.html.defaultTag())
            o.querySelector(N.html.blockTagsQuery())
              ? (o.outerHTML = o.innerHTML)
              : (o.outerHTML = "<"
                  .concat(N.html.defaultTag(), ">")
                  .concat(o.innerHTML, "</")
                  .concat(N.html.defaultTag(), ">"));
          else {
            var i = o.querySelectorAll("*");
            !i.length ||
            ("BR" !== i[i.length - 1].tagName && 0 === o.innerText.length)
        ...
        for (
          r = f(
            Array.prototype.slice.call(n.querySelectorAll("div:not([style])"))
          );
          r.length;
      ...
      function p() {
        N.el.removeEventListener("copy", e),
          N.el.removeEventListener("cut", e),
          N.el.removeEventListener("paste", t);
      }
      return {
        _init: function u() {
          N.el.addEventListener("copy", e),
            N.el.addEventListener("cut", e),
            N.el.addEventListener("paste", t, { capture: !0 }),
            N.events.on("drop", r),
            N.browser.msie &&
              N.browser.version < 11 &&
              (N.events.on(
                "mouseup",
                function (e) {
                  2 === e.button &&
              ...
              N.events.on("beforepaste", t)),
            N.events.on("destroy", p);
        },
    ...
    Object.assign(V.DEFAULTS, { shortcutsEnabled: [], shortcutsHint: !0 }),
    (V.SHORTCUTS_MAP = {}),
    ...
    V.RegisterShortcut(
      V.KEYCODE.CLOSE_SQUARE_BRACKET,
      "indent",
      null,
      "]",
      !1,
      ...
      function e(e) {
        ...
        if (
          ...
          if (i && 0 <= s.opts.shortcutsEnabled.indexOf(i)) {
            ...
            if (
              i &&
              (s.commands[i] || (V.COMMANDS[i] && V.COMMANDS[i].callback))
            )
              return (
                e.preventDefault(),
                e.stopPropagation(),
                "keydown" === e.type &&
                  ((s.commands[i] || V.COMMANDS[i].callback)(), (l = !0)),
                !1
              );
          }
        }
        ...
        get: function o(e) {
          ...
          if (!r)
            for (var t in ((r = {}), V.SHORTCUTS_MAP))
              Object.prototype.hasOwnProperty.call(V.SHORTCUTS_MAP, t) &&
                ...
                (r[
                  ""
                    .concat(V.SHORTCUTS_MAP[t].cmd, ".")
                    .concat(V.SHORTCUTS_MAP[t].val || "")
                ] = {
          ...
          return n
            ? (s.helpers.isMac()
                ...
                : "".concat(s.language.translate("Ctrl"), "+")) +
                (n.shift
                  ? s.helpers.isMac()
                    ? String.fromCharCode(8679)
                    : "".concat(s.language.translate("Shift"), "+")
                  : "") +
                (n.option
                  ? s.helpers.isMac()
                    ? String.fromCharCode(8997)
                    : "".concat(s.language.translate("Alt"), "+")
                  : "") +
                n.letter
            : null;
        },
    ...
    (V.MODULES.snapshot = function (l) {
      function n(e) {
        for (
          var t = e.parentNode.childNodes, n = 0, r = null, o = 0;
          o < t.length;
          o++
        ) {
          if (r) {
      ...
      return {
        get: function a() {
          ...
          if (
            ...
            (t.html = (l.$wp ? l.$el.html() : l.$oel.get(0).outerHTML).replace(
              / style=""/g,
              ""
            )),
            (t.ranges = []),
        ...
        equal: function d(e, t) {
          return (
            e.html === t.html &&
            (!l.core.hasFocus() ||
              JSON.stringify(e.ranges) === JSON.stringify(t.ranges))
          );
        },
      };
    }),
    (V.MODULES.undo = function (n) {
      function e(e) {
        var t = e.which;
        n.keys.ctrlKey(e) &&
          (t === V.KEYCODE.Z && e.shiftKey && e.preventDefault(),
        ...
        _init: function a() {
          o(),
            n.events.on("initialized", function () {
              t = (n.$wp ? n.$el.html() : n.$oel.get(0).outerHTML).replace(
                / style=""/g,
                ""
              );
            }),
            ...
            (void 0 === e
              ? ((e = n.snapshot.get()),
                (n.undo_stack[n.undo_index - 1] &&
                  n.snapshot.equal(n.undo_stack[n.undo_index - 1], e)) ||
                  (r(),
                  n.undo_stack.push(e),
                  n.undo_index++,
                  e.html !== t &&
                    (n.events.trigger("contentChanged"), (t = e.html))))
              : (r(),
                0 < n.undo_index
      ...
      function n() {
        e.opts.heightMin
          ...
          e.opts.heightMax
            ...
            : (e.$wp.css("maxHeight", ""), e.$wp.css("overflow", "")),
          e.opts.height
    ...
    (V.MODULES.core = function (a) {
      ...
      function n() {
        if (
          (a.$box.addClass(
            "fr-box".concat(
              a.opts.editorClass ? " ".concat(a.opts.editorClass) : ""
            )
          ),
              ...
              for (var n = 0, r = t.length; n < r; n++)
                !t[n].selectorText ||
                  (0 !== t[n].selectorText.indexOf(".fr-view") &&
                    0 !== t[n].selectorText.indexOf(".fr-element")) ||
                  (0 < t[n].style.cssText.length &&
                    (0 === t[n].selectorText.indexOf(".fr-view")
                      ? (a.opts.iframeStyle += ""
                          .concat(
                            t[n].selectorText.replace(/\.fr-view/g, "body"),
                            "{"
                          )
                          .concat(t[n].style.cssText, "}"))
                      : (a.opts.iframeStyle += ""
                          .concat(
                            t[n].selectorText.replace(/\.fr-element/g, "body"),
                            "{"
                          )
                          .concat(t[n].style.cssText, "}"))));
          }
        }
        "auto" !== a.opts.direction &&
          a.$box
            .removeClass("fr-ltr fr-rtl")
            .addClass("fr-".concat(a.opts.direction)),
      ...
      return {
        _init: function o() {
          if (
            ...
            n(),
              ...
              a.helpers.isMobile() &&
                (a.$el.attr("autocomplete", a.opts.spellcheck ? "on" : "off"),
                a.$el.attr("autocorrect", a.opts.spellcheck ? "on" : "off"),
                a.$el.attr("autocapitalize", a.opts.spellcheck ? "on" : "off")),
              a.opts.disableRightClick &&
                a.events.$on(a.$el, "contextmenu", function (e) {
                  if (2 === e.button)
                    return e.preventDefault(), e.stopPropagation(), !1;
                });
            try {
          ...
          "TEXTAREA" === a.$oel.get(0).tagName &&
            ...
            a.$oel.val(a.html.get())),
            a.helpers.isIOS() &&
              a.events.$on(a.$doc, "selectionchange", function () {
            ...
            a.$wp &&
              ("TEXTAREA" === a.$oel.get(0).tagName
                ...
                : (a.$wp.replaceWith(e),
                  a.$el.html(""),
                  a.$box.removeClass(
                    "fr-view fr-ltr fr-box ".concat(a.opts.editorClass || "")
                  ),
                  a.opts.theme &&
                    a.$box.addClass("".concat(a.opts.theme, "-theme")))),
            (this.$wp = null),
            (this.$el = null),
            (this.el = null),
            (this.$box = null);
        ...
        getXHR: function i(e, t) {
          ...
          a.opts.requestHeaders))
            Object.prototype.hasOwnProperty.call(a.opts.requestHeaders, r) &&
              n.setRequestHeader(r, a.opts.requestHeaders[r]);
          return n;
        },
        ...
        hasFocus: function l() {
          return a.browser.mozilla && a.helpers.isMobile()
            ? a.selection.inEditor()
            : a.node.hasFocus(a.el) || 0 < a.$el.find("*:focus").length;
        },
    ...
    (V.POPUP_TEMPLATES = { "text.edit": "[_EDIT_]" }),
    ...
    (V.MODULES.popups = function (u) {
      ...
      function m(e, t) {
        t.isVisible() || (t = u.$sc),
          t.is(g[e].data("container")) ||
            (g[e].data("container", t), t.append(g[e]));
      }
      function o(e) {
        var t;
        e.find(".fr-upload-progress").addClass("fr-height-set"),
          e.find(".fr-upload-progress").removeClass("fr-height-auto"),
          u.popups.get("filesManager.insert").removeClass("fr-height-auto"),
          e.find(".fr-files-upload-layer").hasClass("fr-active") && (t = 1),
          e.find(".fr-files-by-url-layer").hasClass("fr-active") && (t = 2),
          e.find(".fr-files-embed-layer").hasClass("fr-active") && (t = 3),
          e.find(".fr-upload-progress-layer").get(0).clientHeight + 10 <
            e.find(".fr-upload-progress").get(0).clientHeight &&
            e.find(".fr-upload-progress").addClass("fr-height-auto"),
          400 < e[0].clientHeight &&
            (e[0].childNodes[4].style.height = "".concat(
              e[0].clientHeight -
      ...
      function C(e) {
        return (
          (g[e] &&
            u.node.hasClass(g[e], "fr-active") &&
            u.core.sameInstance(g[e])) ||
          !1
        );
      }
      function v(e) {
      ...
      function n(e) {
        var t = null;
        if (
          ((t = "string" != typeof e ? e : g[e]),
          "filesManager.insert" === e &&
            u.filesManager !== undefined &&
            u.filesManager.isChildWindowOpen())
        )
          return !1;
        if (
          t &&
          u.node.hasClass(t, "fr-active") &&
          (t.removeClass("fr-active fr-above"),
          u.events.trigger("popups.hide.".concat(e)),
          u.$tb &&
            (1 < u.opts.zIndex
              ? u.$tb.css("zIndex", u.opts.zIndex + 1)
              : u.$tb.css("zIndex", "")),
          ...
          for (var n = 0; n < h.length; n++)
            d(h[n]).removeClass("fr-btn-active-popup");
      }
      function b(e) {
        for (var t in (void 0 === e && (e = []), g))
          Object.prototype.hasOwnProperty.call(g, t) &&
            e.indexOf(t) < 0 &&
            n(t);
      }
      ...
      function c(e, t) {
        var n,
          r = (function c(e, t) {
            ...
            if (!n) return null;
            for (var r in ("function" == typeof n && (n = n.apply(u)), t))
              Object.prototype.hasOwnProperty.call(t, r) &&
                (n = n.replace("[_".concat(r.toUpperCase(), "_]"), t[r]));
            return n;
          })(e, t),
        ...
        if (!r)
          return (
            "filesManager.insert" === e
              ? o.addClass("fr-popup fr-files-manager fr-empty")
              : o.addClass("fr-popup fr-empty"),
        ...
        "filesManager.insert" === e
          ? o.addClass(
              "fr-popup fr-files-manager"
                .concat(u.helpers.isMobile() ? " fr-mobile" : " fr-desktop")
                .concat(u.opts.toolbarInline ? " fr-inline" : "")
            )
          : o.addClass(
              "fr-popup"
                .concat(u.helpers.isMobile() ? " fr-mobile" : " fr-desktop")
          ...
          o.html(r),
          u.opts.theme && o.addClass("".concat(u.opts.theme, "-theme")),
          1 < u.opts.zIndex &&
            (!u.opts.editInPopup && u.$tb
              ? u.$tb.css("z-index", u.opts.zIndex + 2)
              : o.css("z-index", u.opts.zIndex + 2)),
          "auto" !== u.opts.direction &&
            o
              .removeClass("fr-ltr fr-rtl")
              .addClass("fr-".concat(u.opts.direction)),
          o
            .find("input, textarea")
            .attr("dir", u.opts.direction)
      ...
      function E(r) {
        ...
        return {
          _windowResize: function () {
            ...
            !e.helpers.isMobile() &&
              o.isVisible() &&
              (e.events.disableBlur(), e.popups.hide(r), e.events.enableBlur());
          },
          _inputFocus: function (e) {
            ...
            if (
              (n.is("input:file") &&
                n.closest(".fr-layer").addClass("fr-input-focus"),
              e.preventDefault(),
              e.stopPropagation(),
              setTimeout(function () {
                t.events.enableBlur();
          ...
          _inputBlur: function (e) {
            var t = o.data("instance") || u,
              n = d(e.currentTarget);
            n.is("input:file") &&
              n.closest(".fr-layer").removeClass("fr-input-focus"),
              document.activeElement !== this &&
                d(this).isVisible() &&
                (t.events.blurActive() && t.events.trigger("blur"),
                t.events.enableBlur());
          },
          ...
          _preventFocus: function (e) {
            var t = o.data("instance") || u,
              n = e.originalEvent
                ? e.originalEvent.target || e.originalEvent.originalTarget
                : null;
            "mouseup" === e.type || d(n).is(":focus") || t.events.disableBlur(),
              "mouseup" !== e.type ||
                ...
                u.button.hideActiveDropdowns(o),
              (u.browser.safari || u.browser.mozilla) &&
                "mousedown" === e.type &&
          ...
          _windowMouseup: function (e) {
            ...
            o.isVisible() &&
              l() &&
              (e.stopPropagation(), t.markers.remove(), t.popups.hide(r), L());
          },
              ...
              if (t.popups.isVisible(r) && t.opts.toolbarInline)
                return (
                  ...
                  t.popups.isVisible(r) &&
                    (o.findVisible(".fr-back").length
                      ? (t.button.exec(o.findVisible(".fr-back").first()),
                        t.accessibility.focusPopupButton(o))
                      : o.findVisible(".fr-dismiss").length
                      ? t.button.exec(o.findVisible(".fr-dismiss").first())
                      : (t.popups.hide(r),
          ...
          _repositionPopup: function () {
            if ((!u.opts.height && !u.opts.heightMax) || u.opts.toolbarInline)
              return !0;
            if (u.$wp && C(r) && o.parent().get(0) === u.$sc.get(0)) {
              ...
              u.node.hasClass(o.get(0), "fr-above") && (e += o.outerHeight()),
                t < e || e < 0
                  ? o.addClass("fr-hidden")
                  : o.removeClass("fr-hidden");
            }
          },
        };
      }
      function f(e, t) {
        u.events.on("mouseup", e._editorMouseup, !0),
          u.$wp && u.events.on("keydown", e._editorKeydown),
          ...
          u.events.on("blur", function () {
            v() && u.markers.remove(),
              u.helpers.isMobile()
                ? g[t].hasClass("focused")
                  ? (b(), g[t].removeClass("focused"))
                  : g[t].addClass("focused")
                : g[t].find("iframe").length || b();
          }),
          u.$wp &&
            !u.helpers.isMobile() &&
            u.events.$on(u.$wp, "scroll.popup".concat(t), e._repositionPopup),
          u.events.on("window.mouseup", e._windowMouseup, !0),
          u.events.on("window.keydown", e._windowKeydown, !0),
          g[t].data("inst".concat(u.id), !0),
          u.events.on(
            "destroy",
            function () {
              u.core.sameInstance(g[t]) &&
                (d("body").first().append(g[t]), g[t].removeClass("fr-active"));
            },
            !0
          );
      }
        ...
        (u.shared.exit_flag = !1),
        {
          _init: function y() {
            (r = window.innerHeight),
              u.events.on("shared.destroy", e, !0),
              u.events.on("window.mousedown", t),
              u.events.on("window.touchmove", L),
              u.events.$on(d(u.o_win), "scroll", L),
              u.events.on("mousedown", function (e) {
                v() &&
                  (e.stopPropagation(),
                  u.$el.find(".fr-marker").remove(),
                  t(),
                  u.events.disableBlur());
              });
          },
          create: function S(e, t) {
            ...
            return (
                ...
                for (var t = 0; t < e.length; t++) {
                  ...
                  0 === r.next().length &&
                    ...
                    (r.after(
                      '<label for="'
                        .concat(r.attr("id"), '">')
                        .concat(r.attr("placeholder"), "</label>")
                    ),
                    r.attr("placeholder", ""));
                }
              })(o),
              u.events.$on(o, "focus", a),
              u.events.$on(o, "blur change", s),
              u.events.$on(n, "click", ".fr-checkbox + label", p),
              u.accessibility.registerPopup(e),
              u.helpers.isIOS() &&
                u.events.$on(
                  n,
                  "touchend",
              ...
              u.events.$on(d(u.o_win), "resize", r._windowResize, !0),
              "filesManager.insert" === e &&
                g["filesManager.insert"].css("zIndex", 2147483641),
              n
            );
          },
          get: function T(e) {
          ...
          show: function M(e, t, n, r, o) {
            if (
              (C(e) ||
                (v() && 0 < u.$el.find(".fr-marker").length
                  ? (u.events.disableBlur(), u.selection.restore())
                  : v() ||
                    (u.events.disableBlur(),
                    u.events.focus(),
                    u.events.enableBlur())),
            ...
            if (
              ((function p(e, t) {
                t.isVisible() || (t = u.$sc),
                  t.contains([g[e].get(0)]) || t.append(g[e]);
              })(e, s),
              u.opts.toolbarInline &&
                ...
                (n =
                  u.$tb.offset().top -
                  u.helpers.getPX(u.$tb.css("margin-top"))),
                (t = u.$tb.offset().left + u.$tb.outerWidth() / 2),
                u.node.hasClass(u.$tb.get(0), "fr-above") &&
                  n &&
                  (n += u.$tb.outerHeight()),
                (r = 0)),
              (s = g[e].data("container")),
              u.opts.iframe && !r && !a)
            ) {
              var l = u.helpers.getPX(
                  u.$wp.find(".fr-iframe").css("padding-top")
                ),
                c = u.helpers.getPX(
                  u.$wp.find(".fr-iframe").css("padding-left")
                );
              t && (t -= u.$iframe.offset().left + c),
                n && (n -= u.$iframe.offset().top + l);
            }
            s.is(u.$tb)
              ? u.$tb.css("zIndex", (u.opts.zIndex || 1) + 4)
              : g[e].css("zIndex", (u.opts.zIndex || 1) + 3),
              u.opts.toolbarBottom &&
                s &&
                u.$tb &&
                s.get(0) === u.$tb.get(0) &&
                (g[e].addClass("fr-above"), n && (n -= g[e].outerHeight())),
              o && (t -= g[e].width() / 2),
              t + g[e].outerWidth() > u.$sc.offset().left + u.$sc.width() &&
                (t -=
                  t + g[e].outerWidth() - u.$sc.offset().left - u.$sc.width()),
              t < u.$sc.offset().left &&
                "rtl" === u.opts.direction &&
                (t = u.$sc.offset().left),
              g[e].removeClass("fr-active"),
              u.position.at(t, n, g[e], r || 0);
            var d = u.node.blockParent(u.selection.blocks()[0]);
            if (d && "false" === d.getAttribute("contenteditable"))
              g[e].removeClass("fr-active");
            else {
              var f = u.selection
                .element()
                .parentElement.getAttribute("contenteditable");
              f && "false" === f
                ? g[e].removeClass("fr-active")
                : g[e].addClass("fr-active");
            }
            a || u.accessibility.focusPopup(g[e]),
              u.opts.toolbarInline && u.toolbar.hide(),
              u.$tb && (h = u.$tb.find(".fr-btn-active-popup")),
              u.events.trigger("popups.show.".concat(e)),
          ...
          refresh: function A(e) {
            g[e].data("instance", u),
              u.events.trigger("popups.refresh.".concat(e));
          ...
          setPopupDimensions: function w(e, t) {
            t &&
              e.find(".fr-upload-progress-layer").get(0).clientHeight < i &&
              (e.find(".fr-upload-progress").addClass("fr-height-auto"),
              u.popups.get("filesManager.insert").addClass("fr-height-auto"),
              e.find(".fr-upload-progress").removeClass("fr-height-set"),
              (i = 2e3)),
              e.get(0).clientHeight > window.innerHeight / 2 &&
                (window.innerWidth < 500
                  ? e.get(0).clientHeight > 0.6 * r && o(e)
                  : 400 < e.get(0).clientHeight && o(e),
                (i = e.find(".fr-upload-progress-layer").get(0).clientHeight));
    ...
    (V.MODULES.accessibility = function (f) {
      ...
      function l(t) {
        for (
          var e = f.$el.find('[contenteditable="true"]'), n = !1, r = 0;
          e.get(r);
        ...
        t &&
          ...
          (t.data("blur-event-set") ||
            ...
            (f.events.$on(
              ...
              function () {
                var e =
                  t.parents(".fr-toolbar, .fr-popup").data("instance") || f;
                e.events.blurActive() &&
                  !f.core.hasFocus() &&
        ...
        return (
          f.shared.$f_el.is(".fr-dropdown.fr-active")
            ...
            : f.shared.$f_el
              ...
              (e = f.shared.$f_el.closest(".fr-dropdown-menu").prev()),
          e
        );
      }
      function s(e) {
        ...
        var r = e.index(
          f.$tb.find(".fr-more-toolbar.fr-expanded > button.fr-command").first()
        );
        if (0 < r && -1 !== t) {
      ...
      function g(e) {
        return e
          ...
          .filter(function (e) {
            ...
            return (
              0 === t.length || (0 < t.length && t.hasClass("fr-expanded"))
            );
          });
      }
      function n(e, t, n) {
          ...
          if (f.shared.$f_el.hasClass("fr-dropdown"))
            ...
            if (
              ...
              t.hasClass("fr-expanded") &&
                (n = t.findVisible("button:not(.fr-disabled)").first()),
                n && l(n);
      ...
      function L() {
        f.shared.$f_el &&
          ...
          !1 !== f.events.trigger("toolbar.focusEditor") &&
            (f.events.disableBlur(), f.$el.get(0).focus(), f.events.focus());
      }
      function o(r) {
        r &&
          r.length &&
      ...
      return {
          ...
          f.$wp
            ...
            f.events.on(
              ...
              function (e) {
                y(f),
                  f.shared.$f_el &&
                    f.el.isSameNode(f.shared.$f_el[0]) &&
                ...
                _tiKeydown: function (e) {
                  ...
                  if (V.KEYCODE.TAB === n) {
                    ...
                    if (
                      ...
                      return V.KEYCODE.ESC === n
                        ? (e.preventDefault(),
                          e.stopPropagation(),
                          t.accessibility.restoreSelection(),
                          t.popups.isVisible(c) &&
                          d.findVisible(".fr-back").length
                            ? (t.opts.toolbarInline &&
                                (t.events.disableBlur(), t.events.focus()),
                              t.button.exec(d.findVisible(".fr-back").first()),
                              E(d))
                            : t.popups.isVisible(c) &&
                              d.findVisible(".fr-dismiss").length
                            ? t.button.exec(
                                d.findVisible(".fr-dismiss").first()
                              )
                            : (t.popups.hide(c),
                              t.opts.toolbarInline &&
                                t.toolbar.showInline(null, !0),
                          ...
                          !1)
                        : V.KEYCODE.SPACE === n &&
                          (r.is(".fr-submit") || r.is(".fr-dismiss"))
                        ? (e.preventDefault(),
                          e.stopPropagation(),
                          t.events.disableBlur(),
                          t.button.exec(r),
                        ...
                        ? void e.stopPropagation()
                        : V.KEYCODE.SPACE === n &&
                          (r.is(".fr-link-attr") || r.is("input[type=file]"))
                        ? void e.stopPropagation()
                        : (e.stopPropagation(), e.preventDefault(), !1);
                    var l = null;
                    0 < d.findVisible(".fr-submit").length
                      ? (l = d.findVisible(".fr-submit").first())
                      : d.findVisible(".fr-dismiss").length &&
                        (l = d.findVisible(".fr-dismiss").first()),
                      l &&
                        (e.preventDefault(),
                        e.stopPropagation(),
                        t.events.disableBlur(),
        ...
        focusModal: function M(e) {
          f.core.hasFocus() || (f.events.disableBlur(), f.events.focus()),
            ...
            f.events.disableBlur(),
            f.shared.with_kb
              ? e.find(".fr-command[tabIndex], [tabIndex]").first().focus()
              : e.find("[tabIndex]").first().focus();
        },
        focusEditor: L,
        focusPopupButton: E,
        ...
        exec: function x(e, t) {
          var n =
            ...
            o = !1;
          return (
            r !== V.KEYCODE.TAB || n || e.shiftKey || e.altKey
              ? r !== V.KEYCODE.ARROW_RIGHT || n || e.shiftKey || e.altKey
                ? r !== V.KEYCODE.TAB || n || !e.shiftKey || e.altKey
                  ? r !== V.KEYCODE.ARROW_LEFT || n || e.shiftKey || e.altKey
                    ? r !== V.KEYCODE.ARROW_UP || n || e.shiftKey || e.altKey
                      ? r !== V.KEYCODE.ARROW_DOWN ||
                        n ||
                        e.shiftKey ||
                        e.altKey
                        ? (r !== V.KEYCODE.ENTER && r !== V.KEYCODE.SPACE) ||
                          n ||
                          e.shiftKey ||
                          e.altKey
                          ? r !== V.KEYCODE.ESC || n || e.shiftKey || e.altKey
                            ? r !== V.KEYCODE.F10 ||
                              n ||
                              e.shiftKey ||
                              !e.altKey ||
                            ...
                            : (o = (function i(e) {
                                if (f.shared.$f_el) {
                                  ...
                                  return (
                                    t
                                      ? (f.button.click(t), l(t))
                                      : e.parent().findVisible(".fr-back")
                                          .length
                                      ? ((f.shared.with_kb = !1),
                                      ...
                                      : f.shared.$f_el.is(
                                        ...
                                        (e.parent().is(".fr-popup")
                                          ? (f.accessibility.restoreSelection(),
                                            (f.shared.$f_el = null),
                                            !1 !==
                                              f.events.trigger("toolbar.esc") &&
                                              (f.popups.hide(e.parent()),
                                              f.opts.toolbarInline &&
                        ...
                        : (o = (function a() {
                            return f.shared.$f_el &&
                              f.shared.$f_el.is(".fr-dropdown:not(.fr-active)")
                              ? b()
                              : v(!0);
                          })())
                      : (o = (function s() {
    ...
    Object.assign(V.DEFAULTS, { tooltips: !0 }),
    (V.MODULES.tooltip = function (i) {
      ...
      function o(e, t) {
        if (
          !i.helpers.isMobile() &&
          (e.data("title") || e.data("title", e.attr("title")), e.data("title"))
        ) {
          i.$tooltip ||
            (function o() {
              i.opts.tooltips &&
                ...
                (i.shared.$tooltip
                  ...
                  : ((i.shared.$tooltip = a(
                    ...
                    (i.$tooltip = i.shared.$tooltip),
                    i.opts.theme &&
                      i.$tooltip.addClass("".concat(i.opts.theme, "-theme")),
          ...
          var n =
            e.offset().left + (e.outerWidth() - i.$tooltip.outerWidth()) / 2;
          n < 0 && (n = 0),
            n + i.$tooltip.outerWidth() > a(i.o_win).width() &&
              (n = a(i.o_win).width() - i.$tooltip.outerWidth()),
            void 0 === t && (t = i.opts.toolbarBottom),
            e.offset().top - a(window).scrollTop() + e.outerHeight() + 10 >=
              a(window).height() && (t = !0);
          var r = t
            ? e.offset().top - i.$tooltip.height()
            : e.offset().top + e.outerHeight();
          i.$tooltip.css("position", ""),
            i.$tooltip.css("left", n),
            i.$tooltip.css("top", Math.ceil(r)),
            "static" !== a(i.o_doc).find("body").first().css("position")
              ? (i.$tooltip.css(
                  "margin-left",
                  -a(i.o_doc).find("body").first().offset().left
                ),
                i.$tooltip.css(
                  "margin-top",
                  -a(i.o_doc).find("body").first().offset().top
                ))
              : (i.$tooltip.css("margin-left", ""),
        ...
        bind: function s(e, t, n) {
          i.opts.tooltips &&
            ...
            (i.events.$on(
              ...
              t,
              function (e) {
                i.node.hasClass(e.currentTarget, "fr-disabled") ||
                  i.edit.isDisabled() ||
                  o(a(e.currentTarget), n);
              },
              !0
            ),
            i.events.$on(
              e,
              "mouseout ".concat(i._mousedown, " ").concat(i._mouseup),
              t,
              function () {
                r();
              },
    ...
    (V.MODULES.button = function (g) {
      ...
      (g.opts.toolbarInline || g.opts.toolbarContainer) &&
        (g.shared.buttons || (g.shared.buttons = []), (a = g.shared.buttons));
      var s = [];
      function l(e, t, n) {
      ...
      function o(e) {
        ...
        o.helpers.isIOS() &&
          !o.el.querySelector(".fr-marker") &&
          (o.selection.save(), o.selection.clear(), o.selection.restore()),
        ...
        if (!n) {
          ...
          t
            ...
            V.COMMANDS[l] &&
              V.COMMANDS[l].refreshOnShow &&
              V.COMMANDS[l].refreshOnShow.apply(o, [e, t]),
            t.css(
              "left",
              e.offset().left -
                e.parents(".fr-btn-wrap, .fr-toolbar, .fr-buttons").offset()
                  .left -
                ("rtl" === g.opts.direction ? t.width() - e.outerWidth() : 0)
            ),
          ...
          if (
            ...
            t.offset().top + e.outerHeight() + i < h(g.o_doc).height()
          )
            ...
            0 < f.length && (d = f.first().height()),
              t.css(
                "bottom",
                e.parents(".fr-popup, .fr-toolbar").first().height() -
                  d -
                  e.position().top
              );
          }
        ...
        g.helpers.isMobile() ||
          (p.length
            ? (g.accessibility.focusToolbarElement(p),
              s.scrollTop(
                Math.abs(
                  p.parents(".fr-dropdown-content").offset().top -
                    p.offset().top
                ) - p.offset().top
              ))
            : (g.accessibility.focusToolbarElement(e), s.scrollTop(0)));
      }
      function i(e) {
        e.addClass("fr-blink"),
          setTimeout(function () {
      ...
      function t(e) {
        ...
        if (
          ...
          for (var n = 0; n < V.INSTANCES.length; n++)
            V.INSTANCES[n] !== t &&
              V.INSTANCES[n].popups &&
              V.INSTANCES[n].popups.areVisible() &&
              V.INSTANCES[n].$el.find(".fr-marker").remove();
          t.popups.hideAll();
        }
        g.node.hasClass(e.get(0), "fr-dropdown")
          ...
          : (!(function r(e) {
            ...
            V.COMMANDS[e.data("cmd")] &&
              !1 !== V.COMMANDS[e.data("cmd")].refreshAfterCallback &&
      ...
      function C(e) {
        ...
        if ("options" !== t.type)
          if (r) {
            ...
            o = '<span style="width:'
              ...
              .concat(g.language.translate(i || t.title), "</span>");
          } else
            (o = g.icon.create(t.icon || e)),
              (o += '<span class="fr-sr-only">'.concat(
        ...
        var c = "".concat(e, "-").concat(g.id),
          ...
          f = '<button id="'
            .concat(c, '"')
            .concat(
              t.more_btn ? ' data-group-name="'.concat(c, '" ') : "",
            ...
            .concat(t.disabled ? ' aria-disabled="true"' : "", ' title="')
            ...
            if (t.html)
              ...
              r))
                if (Object.prototype.hasOwnProperty.call(r, o)) {
                  ...
                  (i = i
                    ? '<span class="fr-shortcut">'.concat(i, "</span>")
                    : ""),
                    (n += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="'
                      ...
                      .concat(o, '" title="')
                      .concat(r[o], '">')
                      .concat(g.language.translate(r[o]), "</a></li>"));
                }
              n += "</ul>";
            }
            return n;
          ...
          t.hasOptions &&
            ...
            (f = '<div class="fr-btn-wrap">'
              ...
              .concat(
                C(
                  e + "Options",
                  Object.assign({}, t, { type: "options", hasOptions: !1 }),
                  n
                ),
                "  </div>"
              )),
      ...
      function e(o) {
        ...
        setTimeout(function () {
          for (
            var e = i.selection.inEditor() && i.core.hasFocus(), t = 0;
            t < o.length;
            t++
          ) {
            var n = h(o[t]),
            ...
            0 === n.parents(".fr-popup").length
              ? e || (V.COMMANDS[r] && V.COMMANDS[r].forcedRefresh)
                ? i.button.refresh(n)
                : g.node.hasClass(n.get(0), "fr-dropdown") ||
                  (n.removeClass("fr-active"),
                  n.attr("aria-pressed") && n.attr("aria-pressed", !1))
              : n.parents(".fr-popup").isVisible() && i.button.refresh(n);
          }
        }, 0);
      }
      function n() {
      ...
      return {
        _init: function b() {
          g.opts.toolbarInline
            ...
            : (g.events.on("mouseup", v),
              g.events.on("keyup", v),
              g.events.on("blur", v),
              g.events.on("focus", v),
              g.events.on("contentChanged", v),
              g.helpers.isMobile() &&
        ...
        buildList: function L(e, t) {
          for (var n = "", r = 0; r < e.length; r++) {
            var o = e[r],
              i = V.COMMANDS[o];
            (i &&
              "undefined" != typeof i.plugin &&
              g.opts.pluginsEnabled.indexOf(i.plugin) < 0) ||
              (i
                ? (n += C(o, i, void 0 === t || 0 <= t.indexOf(o)))
                : "|" === o
                ? (n +=
        ...
        buildGroup: function E(e) {
                ...
                p ||
                  ...
                  !p ||
                    (p &&
                      ...
                      g.opts.pluginsEnabled.indexOf(p.plugin) < 0) ||
                    (e[r].align !== undefined && (l = e[r].align),
          ...
          return g.opts.toolbarBottom
            ? "".concat(n, '<div class="fr-newline"></div>').concat(t)
            : "".concat(t, '<div class="fr-newline"></div>').concat(n);
        },
        bindCommands: function y(t, e) {
          ...
          function o(e) {
            (!e ||
              (e.type === g._mouseup && e.target !== h("html").get(0)) ||
              ("keydown" === e.type &&
                ((g.keys.isCharacter(e.which) && !g.keys.ctrlKey(e)) ||
                  e.which === V.KEYCODE.ESC))) &&
              d(t);
          }
          g.events.$on(h(r), "".concat(g._mouseup, " resize keydown"), o, !0),
            ...
            g.node.hasClass(t.get(0), "fr-popup")
              ...
              : h.merge(a, t.find(".fr-btn").toArray()),
        ...
        refresh: function S(e) {
          ...
          g.node.hasClass(e.get(0), "fr-dropdown")
            ...
            V.COMMANDS[r] && V.COMMANDS[r].refresh
              ? V.COMMANDS[r].refresh.apply(n, [e, t])
    ...
    Object.assign(V.DEFAULTS, { iconsTemplate: "svg" }),
    (V.MODULES.icon = function (o) {
      return {
        ...
        getTemplate: function r(e) {
          ...
          return void 0 !== t
            ? (n =
                t.template || V.ICON_DEFAULT_TEMPLATE || o.opts.iconsTemplate)
            : n;
        },
    ...
    (V.MODULES.modals = function (l) {
        ...
        if (c[e]) {
          ...
          r.events.enableBlur(),
            ...
            a(r.o_doc)
              .find("body")
              .first()
              .removeClass("fr-prevent-scroll fr-mobile"),
            n.removeClass("fr-active"),
            t ||
      ...
      function n(e) {
        ...
        return (
          (t && l.node.hasClass(t, "fr-active") && l.core.sameInstance(t)) || !1
        );
      }
      return {
        _init: function t() {
        ...
        create: function d(n, e, t) {
          if (
            ((e = '<div class="fr-modal-head-line">'.concat(e, "</div>")),
            l.shared.$overlay ||
              ((l.shared.$overlay = a(l.doc.createElement("DIV")).addClass(
                "fr-overlay"
              )),
            ...
            var r = (function i(e, t) {
              var n = '<div tabIndex="-1" class="fr-modal'.concat(
                  l.opts.theme ? " ".concat(l.opts.theme, "-theme") : "",
            ...
            (c[n] = {
              ...
              l.events.$on(
                ...
                function (e) {
                  var t = e.which;
                  return t === V.KEYCODE.ESC
                    ? (s(n), l.accessibility.focusModalButton(r), !1)
                    : !(
                        !a(e.currentTarget).is("input[type=text], textarea") &&
                        t !== V.KEYCODE.ARROW_UP &&
                        t !== V.KEYCODE.ARROW_DOWN &&
        ...
        show: function i(e) {
          if (c[e]) {
            ...
            t.data("instance", l),
              t.show(),
              o.show(),
              a(l.o_doc).find("body").first().addClass("fr-prevent-scroll"),
              l.helpers.isMobile() &&
                a(l.o_doc).find("body").first().addClass("fr-mobile"),
          ...
          if (c[e]) {
            var t = c[e],
              ...
              a =
                o -
                i.outerHeight(!0) +
                (i.height() - (r.outerHeight(!0) - r.height())),
              s = "auto";
    ...
    (V.MODULES.position = function (L) {
      ...
      function o() {
        ...
        if ((0 === e.top && 0 === e.left && 0 === e.width) || 0 === e.height) {
          var t = !1;
          0 === L.$el.find(".fr-marker").length &&
            (L.selection.save(), (t = !0));
          ...
          n.css("display", "none"),
            ...
            (e.top =
              r &&
              r.top -
                ((L.helpers.isMobile() && !L.helpers.isIOS()) || L.opts.iframe
                  ? 0
                  : L.helpers.scrollTop())),
            (e.right = 1),
            (e.bottom = 1),
      ...
      function i(e, t, n, r) {
        ...
        if (
          (!o ||
            ...
            (e && (e -= o.offset().left),
            t && (t -= o.offset().top),
            "BODY" !== o.get(0).tagName
              ? (e && (e += o.get(0).scrollLeft),
                t && (t += o.get(0).scrollTop))
              : "absolute" === o.css("position") &&
                (e && (e += o.position().left), t && (t += o.position().top))),
          L.opts.iframe && o && L.$tb && o.get(0) !== L.$tb.get(0))
        ) {
          var i = L.helpers.getPX(L.$wp.find(".fr-iframe").css("padding-top")),
            a = L.helpers.getPX(L.$wp.find(".fr-iframe").css("padding-left"));
          e && (e += L.$iframe.offset().left + a),
            t && (t += L.$iframe.offset().top + i);
        }
        var s = (function l(e, t) {
          var n = e.outerWidth(!0);
          return (
            t + n > L.$sc.get(0).clientWidth - 10 &&
              (t = L.$sc.get(0).clientWidth - n - 10),
            t < 0 && (t = 10),
            t
          );
        })(n, e);
            ...
            n.css(
              ...
              (function c(e, t, n) {
                ...
                if (
                  !L.helpers.isMobile() &&
                  L.$tb &&
                  e.parent().get(0) !== L.$tb.get(0)
                ) {
                  var o = e.parent().offset().top,
                    i = t - r - (n || 0);
                  e.parent().get(0) === L.$sc.get(0) &&
                    (o -= e.parent().position().top);
                  var a = L.$sc.get(0).clientHeight;
                  o + t + r > L.$sc.offset().top + a &&
                  0 < e.parent().offset().top + i &&
                  0 < i
                    ? i > L.$wp.scrollTop() && ((t = i), e.addClass("fr-above"))
      ...
      function t(e) {
        ...
        if (L.core.hasFocus() || 0 < L.$tb.findVisible("input:focus").length) {
          var a = L.helpers.scrollTop(),
            s = Math.min(
              Math.max(a - L.$tb.parent().offset().top, 0),
              L.$tb.parent().outerHeight() - n.outerHeight()
            );
          if (
            (s !== r &&
              s !== o &&
              ...
              n.outerHeight() < a - L.$tb.parent().offset().top &&
              ...
              n.data(
                ...
                setTimeout(function () {
                  var e = L.helpers.scrollTop(),
                    t = Math.min(
                      Math.max(e - L.$tb.parent().offset().top, 0),
                      L.$tb.parent().outerHeight() - n.outerHeight()
                    );
                  0 < t &&
                    "BODY" === L.$tb.parent().get(0).tagName &&
                    (t += L.$tb.parent().position().top),
                    t !== r &&
            ...
            n.css("top", "0"),
              ...
              L.$box.addClass("fr-sticky-box");
          }
        } else
          clearTimeout(E(e).css("sticky-timeout")),
            n.css("top", "0"),
            n.css("position", ""),
            n.css("width", ""),
            n.data("sticky-top", 0),
            n.removeClass("fr-sticky-on"),
            L.$box.removeClass("fr-sticky-box");
      }
      function n(e) {
        if (e.offsetWidth) {
          var t = E(e),
            ...
            o = E(
              "body" === L.opts.scrollableContainer
                ? L.o_win
                : L.opts.scrollableContainer
            ).outerHeight(),
            i = 0,
            a = 0;
          "body" !== L.opts.scrollableContainer &&
            ((i = L.$sc.offset().top), (a = E(L.o_win).outerHeight() - i - o));
          var s =
              "body" === L.opts.scrollableContainer ? L.helpers.scrollTop() : i,
            l = t.is(".fr-sticky-on");
          ...
          if (
            ...
            p || t.css("position", "fixed"),
              ...
              t.data(
                "top",
                L.node.hasClass(t.get(0), "fr-top") ? t.css("top") : "auto"
              ),
              t.data(
                "bottom",
                L.node.hasClass(t.get(0), "fr-bottom")
                  ? t.css("bottom")
                  : "auto"
              );
          }
          var u = L.helpers.getPX(t.data("top")),
            ...
            g =
              ...
              (L.helpers.isInViewPort(L.$sc.get(0)) ||
                "body" === L.opts.scrollableContainer),
            m =
              r.bottom &&
              (function b() {
          ...
          if (g || m) {
            ...
            t.css(
              "width",
              "".concat(c.get(0).getBoundingClientRect().width - C, "px")
            ),
              l ||
                ...
                t.css("bottom") &&
                  ("auto" !== t.data("bottom")
                    ? t.css("bottom", L.helpers.getPX(t.data("bottom")) + a)
                    : t.css("bottom", "auto")));
          } else
            L.node.hasClass(t.get(0), "fr-sticky-off") ||
              (t.css("width", ""),
      ...
      function r() {
        if (
          (L.helpers.requestAnimationFrame()(r),
          !1 !== L.events.trigger("position.refresh"))
        )
          ...
          !(function e() {
            (L._stickyElements = []),
              L.helpers.isIOS()
                ...
                : ("body" !== L.opts.scrollableContainer &&
                    L.events.$on(
                      E(L.opts.scrollableContainer),
                      "scroll",
                      a,
                      !0
                    ),
                  L.events.$on(E(L.o_win), "scroll", a, !0),
                  L.events.$on(E(L.o_win), "resize", a, !0),
                  L.events.on("initialized", a),
                  L.events.on("focus", a),
                  L.events.$on(E(L.o_win), "resize", "textarea", a, !0)),
            ...
            o =
              "rtl" === l.opts.direction
                ? l.$tb.outerWidth() -
                  e.offset().left +
                  l.$tb.offset().left -
                  (n + e.outerWidth() + r.length * (i + a)) / 2
                : e.offset().left -
                  l.$tb.offset().left -
                  (n - e.outerWidth() + r.length * (i + a)) / 2;
            o + n + r.length * (i + a) > l.$tb.outerWidth() &&
              (o -= (n + r.length * (i + a) - e.outerWidth()) / 2);
            o < 0 && (o = 0);
            return o;
          })(e, t);
        "rtl" === l.opts.direction
      ...
      return {
        ...
        outdent: function a(e) {
          ...
          for (var t = l.selection.blocks(), n = 0; n < t.length; n++) {
            var r =
                "rtl" === l.opts.direction || "rtl" === c(t[n]).css("direction")
                  ? "margin-right"
                  : "margin-left",
              o = t[0].parentElement;
            if (
              "UL" != o.parentNode.tagName &&
              "OL" != o.parentNode.tagName &&
              "LI" != o.parentNode.tagName
            )
              return i(e, !0), !0;
            if (
              t[0].previousSibling &&
              "none" == o.parentNode.style.listStyleType
            )
              return i(e, !0), !0;
            if ("LI" === t[n].tagName || "LI" === t[n].parentNode.tagName)
              return i(e, !1), !0;
        ...
        indent: function o(e) {
          ...
          for (var t = l.selection.blocks(), n = 0; n < t.length; n++) {
            for (
              ...
              r && r.nodeType === Node.TEXT_NODE && 0 === r.textContent.length;
    ...
    ((V.TOOLBAR_BUTTONS_SM = {}).moreText = Object.assign(
      {},
      V.TOOLBAR_BUTTONS.moreText,
      { buttonsVisible: 2 }
    )),
    (V.TOOLBAR_BUTTONS_SM.moreParagraph = Object.assign(
      {},
      V.TOOLBAR_BUTTONS.moreParagraph,
      { buttonsVisible: 2 }
    )),
    (V.TOOLBAR_BUTTONS_SM.moreRich = Object.assign(
      {},
      V.TOOLBAR_BUTTONS.moreRich,
      { buttonsVisible: 2 }
    )),
    (V.TOOLBAR_BUTTONS_SM.moreMisc = Object.assign(
      {},
      V.TOOLBAR_BUTTONS.moreMisc,
      { buttonsVisible: 2 }
    )),
    ((V.TOOLBAR_BUTTONS_XS = {}).moreText = Object.assign(
      {},
      V.TOOLBAR_BUTTONS.moreText,
      { buttonsVisible: 0 }
    )),
    (V.TOOLBAR_BUTTONS_XS.moreParagraph = Object.assign(
      {},
      V.TOOLBAR_BUTTONS.moreParagraph,
      { buttonsVisible: 0 }
    )),
    (V.TOOLBAR_BUTTONS_XS.moreRich = Object.assign(
      {},
      V.TOOLBAR_BUTTONS.moreRich,
      { buttonsVisible: 0 }
    )),
    (V.TOOLBAR_BUTTONS_XS.moreMisc = Object.assign(
      {},
      V.TOOLBAR_BUTTONS.moreMisc,
      { buttonsVisible: 2 }
    )),
    ...
    (V.MODULES.toolbar = function (m) {
        ...
        if (C !== m.helpers.screenSize()) {
          ...
          e)) {
            ...
            if (o.buttons) {
              ...
              e.showMoreButtons &&
                (i = v('<div class="fr-more-toolbar"></div>').data(
                  "name",
                  "".concat(r, "-").concat(m.id)
                ));
              for (var c = 0; c < o.buttons.length; c++) {
                ...
                var d = m.$tb.find(
                  ...
                  f = null;
                m.node.hasClass(d.next().get(0), "fr-dropdown-menu") &&
                  (f = d.next()),
                  m.node.hasClass(d.next().get(0), "fr-options") &&
                    (d.removeClass("fr-hidden"),
                    d.next().removeClass("fr-hidden"),
                    (d = d.parent())),
                  d.removeClass("fr-hidden"),
                  e.showMoreButtons && s <= a
                    ? (i.append(d), f && i.append(f))
      ...
      function n(e, t) {
        setTimeout(function () {
          if (
            (!e || e.which != V.KEYCODE.ESC) &&
            m.selection.inEditor() &&
            m.core.hasFocus() &&
            !m.popups.areVisible() &&
            "false" !=
              v(m.selection.blocks()[0])
                .closest("table")
      ...
      function a(e) {
        clearTimeout(i),
          (e && e.which === V.KEYCODE.ESC) ||
            (i = setTimeout(n, m.opts.typingTimer));
      }
      function s() {
        m.events.on("window.mousedown", o),
          ...
          m.helpers.isMobile() &&
            (m.events.$on(m.$doc, "selectionchange", a),
      ...
      function l() {
        m.$tb.html("").removeData().remove(),
          (m.$tb = null),
          m.$second_tb &&
            (m.$second_tb.html("").removeData().remove(),
            (m.$second_tb = null));
      }
      function c() {
      ...
      function d() {
        m.opts.theme && m.$tb.addClass("".concat(m.opts.theme, "-theme")),
          ...
          m.opts.toolbarContainer
            ...
            : (function e() {
                m.opts.toolbarInline
                  ...
                  : (m.opts.toolbarBottom && !m.helpers.isIOS()
                      ? (m.$box.append(m.$tb),
                        m.$tb.addClass("fr-bottom"),
                    ...
                    m.opts.toolbarSticky &&
                      (m.opts.toolbarStickyOffset &&
                        (m.opts.toolbarBottom
                          ? m.$tb.css("bottom", m.opts.toolbarStickyOffset)
                          : m.$tb.css("top", m.opts.toolbarStickyOffset)),
          ...
          (function n() {
            m.events.$on(v(m.o_win), "resize", r),
              m.events.$on(v(m.o_win), "orientationchange", r);
          })(),
            ...
            m.$box.hasClass("fr-fullscreen") &&
              ((m.opts.height =
                ...
                (m.opts.toolbarInline
                  ? 0
                  : m.$tb.outerHeight() +
                    (m.$second_tb ? m.$second_tb.outerHeight() : 0))),
              m.size.refresh());
          });
      }
      var f = !1;
      return {
        _init: function p() {
          ...
          m.opts.toolbarInline ||
            m.opts.toolbarBottom ||
            ((m.$second_tb = v(m.doc.createElement("div")).attr(
              "class",
              "fr-second-toolbar"
            )),
            m.$box.append(m.$second_tb),
            (!1 !== m.ul || m.opts.attribution) &&
              m.$second_tb.prepend(V.POWERED_BY)),
            m.opts.toolbarContainer
              ? (m.shared.$tb
                  ? ((m.$tb = m.shared.$tb), m.opts.toolbarInline && s())
  ...
  var c = ["scroll", "wheel", "touchmove", "touchstart", "touchend"],
    ...
    g = function g(e) {
      return e && "string" == typeof e
        ? e.replace(/^\s*>/g, ":scope >").replace(/,\s*>/g, ", :scope >")
        : e;
    },
    m = function m(e) {
  ...
  (h.fn = h.prototype = {
    ...
    wrapInner: function (e) {
      ...
      for (
        ;
        this[0].firstChild && this[0].firstChild !== e && "string" != typeof e;
    ...
    attr: function (e, t) {
      ...
      if (void 0 === t)
        return 0 === this.length || (!this[0].getAttribute && "checked" !== e)
          ? undefined
          : "checked" === e
          ? this[0].checked
          : "tagName" === e
      ...
      else for (var i = 0; i < this.length; i++) this[i].setAttribute(e, t);
      return this;
    },
    ...
    css: function (e, t) {
      if (void 0 !== t) {
        ...
        (("string" != typeof t || "" === t.trim() || isNaN(t)) &&
          ...
          (t += "px");
        for (var n = 0; n < this.length; n++)
          (e = C(this).getCorrectStyleName(e)), (this[n].style[e] = t);
        return this;
      }
      if ("string" == typeof e) {
        if (0 === this.length) return undefined;
        ...
        return (
          (e = C(this).getCorrectStyleName(e)), o.getComputedStyle(this[0])[e]
        );
      }
      for (var i in e)
    ...
    hasClass: function (e) {
      ...
      for (t = " " + e + " "; (n = this[r++]); )
        if (
          1 === n.nodeType &&
          -1 <
            (" " + C(this).stripAndCollapse(C(this).getClass(n)) + " ").indexOf(
              t
            )
        )
          return !0;
      ...
      for (var r = 0; r < this.length; r++) {
        ...
        if (o.data("events")) {
          ...
          for (var a = o.data("events") || [], s = a.length - 1; 0 <= s; s--) {
            var l = a[s];
            l[0] == e &&
              (o.get(0).removeEventListener(i, l[1]), a.splice(s, 1));
          }
        }
      }
    },
    ...
    find: function (e) {
      ...
      var o = function o(e) {
        return "object" ===
          ("undefined" == typeof HTMLElement ? "undefined" : N(HTMLElement))
    ...
    prev: function () {
      return this.length && this[0].previousElementSibling
        ? C(this[0].previousElementSibling)
        : C();
    },
    next: function () {
    ...
    outerHeight: function (e) {
      ...
      if (
        (e &&
          (i +=
            parseInt(C(t).css("marginTop")) +
            parseInt(C(t).css("marginBottom"))),
        !r)
      )
    ...
    outerWidth: function (e) {
      ...
      if (
        (e &&
          (i +=
            parseInt(C(t).css("marginLeft")) +
            parseInt(C(t).css("marginRight"))),
        !r)
      )
        for (var a in s) t.style[a] = n[a];
      return i;
    ...
    parents: function (e) {
      for (var t = C(), n = 0; n < this.length; n++)
        for (
          ...
          r && r != document && this._matches(r);

        )
          e ? this._matches(r, e) && t.push(r) : t.push(r), (r = r.parentNode);
      return t;
    },
    parentsUntil: function (e, t) {
      ...
      for (var r = 0; r < this.length; r++)
        for (
          var o = this[r].parentNode;
          o &&
          o != document &&
          o.matches &&
          o != e &&
          this[r] != e &&
          ("string" != typeof e || !o.matches(e));
  ...
  function L() {
    (this.doc = this.$el.get(0).ownerDocument),
      ...
      this.opts.pluginsEnabled ||
        (this.opts.pluginsEnabled = Object.keys(b.PLUGINS)),
          ...
          this.$el.on(
            ...
            function r(e) {
              ...
              if (1 === e.which || !e.which) {
                ...
                if (
                  (t && "IMG" === t.tagName && h(t).trigger("mousedown"),
  ...
  return (
    (b.Bootstrap = function (e, t, n) {
      ...
      "function" == typeof t && ((n = t), (t = {})),
        ...
        (this.opts = Object.assign(
          {},
          Object.assign({}, b.DEFAULTS, r, "object" === N(t) && t)
        ));
      var o = JSON.stringify(this.opts);
      (b.OPTS_MAPPING[o] = b.OPTS_MAPPING[o] || this.id),
        (this.sid = b.OPTS_MAPPING[o]),
        (b.SHARED[this.sid] = b.SHARED[this.sid] || {}),
        (this.shared = b.SHARED[this.sid]),
    ...
    (b.Bootstrap.prototype._init = function () {
          ...
          "TEXTAREA" !== e &&
            ...
            this.opts.iframe
              ? ((this.$iframe = h(
                ...
                (this.$html = h(this.iframe_document.querySelector("html"))))
              : ((this.$el = h(this.o_doc.createElement("DIV"))),
                (this.el = this.$el.get(0)),
                (this.$wp = h(this.o_doc.createElement("DIV")).append(
                  this.$el
                )),
                this.$box.html(this.$wp)),
      ...
      this.opts.editInPopup
        ...
        ? o()
        : "BUTTON" === e || "INPUT" === e
        ? ((this.opts.editInPopup = !0), (this.opts.toolbarInline = !1), i())
        : t();
    }),
      ...
      for (var t in e)
        if (Object.prototype.hasOwnProperty.call(e, t)) {
          ...
          if (
            ((this[t] = new e[t](this)),
            this[t]._init &&
              (this[t]._init(), this.opts.initOnClick && "core" === t))
          )
            return !1;
        }
    }),
      ...
      if (
        ...
        for (var t in this.shared)
          Object.prototype.hasOwnProperty.call(this.shared, t) &&
            ((this.shared[t] = null), (b.SHARED[this.sid][t] = null));
